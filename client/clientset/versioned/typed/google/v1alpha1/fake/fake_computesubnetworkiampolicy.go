...
func (c *FakeComputeSubnetworkIamPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.ComputeSubnetworkIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(computesubnetworkiampoliciesResource, name), &v1alpha1.ComputeSubnetworkIamPolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComputeSubnetworkIamPolicies) List(opts v1.ListOptions) (result *v1alpha1.ComputeSubnetworkIamPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(computesubnetworkiampoliciesResource, computesubnetworkiampoliciesKind, opts), &v1alpha1.ComputeSubnetworkIamPolicyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComputeSubnetworkIamPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(computesubnetworkiampoliciesResource, opts))
}
...
func (c *FakeComputeSubnetworkIamPolicies) Create(computeSubnetworkIamPolicy *v1alpha1.ComputeSubnetworkIamPolicy) (result *v1alpha1.ComputeSubnetworkIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(computesubnetworkiampoliciesResource, computeSubnetworkIamPolicy), &v1alpha1.ComputeSubnetworkIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeSubnetworkIamPolicy), err
...
func (c *FakeComputeSubnetworkIamPolicies) Update(computeSubnetworkIamPolicy *v1alpha1.ComputeSubnetworkIamPolicy) (result *v1alpha1.ComputeSubnetworkIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(computesubnetworkiampoliciesResource, computeSubnetworkIamPolicy), &v1alpha1.ComputeSubnetworkIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeSubnetworkIamPolicy), err
...
func (c *FakeComputeSubnetworkIamPolicies) UpdateStatus(computeSubnetworkIamPolicy *v1alpha1.ComputeSubnetworkIamPolicy) (*v1alpha1.ComputeSubnetworkIamPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(computesubnetworkiampoliciesResource, "status", computeSubnetworkIamPolicy), &v1alpha1.ComputeSubnetworkIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeSubnetworkIamPolicy), err
...
func (c *FakeComputeSubnetworkIamPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(computesubnetworkiampoliciesResource, name), &v1alpha1.ComputeSubnetworkIamPolicy{})
	return err
}
...
func (c *FakeComputeSubnetworkIamPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(computesubnetworkiampoliciesResource, listOptions)
...
func (c *FakeComputeSubnetworkIamPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ComputeSubnetworkIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(computesubnetworkiampoliciesResource, name, pt, data, subresources...), &v1alpha1.ComputeSubnetworkIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeSubnetworkIamPolicy), err
