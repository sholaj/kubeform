...
func (c *FakeStorageBucketIamPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(storagebucketiampoliciesResource, name), &v1alpha1.StorageBucketIamPolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStorageBucketIamPolicies) List(opts v1.ListOptions) (result *v1alpha1.StorageBucketIamPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(storagebucketiampoliciesResource, storagebucketiampoliciesKind, opts), &v1alpha1.StorageBucketIamPolicyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStorageBucketIamPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(storagebucketiampoliciesResource, opts))
}
...
func (c *FakeStorageBucketIamPolicies) Create(storageBucketIamPolicy *v1alpha1.StorageBucketIamPolicy) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(storagebucketiampoliciesResource, storageBucketIamPolicy), &v1alpha1.StorageBucketIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageBucketIamPolicy), err
...
func (c *FakeStorageBucketIamPolicies) Update(storageBucketIamPolicy *v1alpha1.StorageBucketIamPolicy) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(storagebucketiampoliciesResource, storageBucketIamPolicy), &v1alpha1.StorageBucketIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageBucketIamPolicy), err
...
func (c *FakeStorageBucketIamPolicies) UpdateStatus(storageBucketIamPolicy *v1alpha1.StorageBucketIamPolicy) (*v1alpha1.StorageBucketIamPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(storagebucketiampoliciesResource, "status", storageBucketIamPolicy), &v1alpha1.StorageBucketIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageBucketIamPolicy), err
...
func (c *FakeStorageBucketIamPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(storagebucketiampoliciesResource, name), &v1alpha1.StorageBucketIamPolicy{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeStorageBucketIamPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(storagebucketiampoliciesResource, listOptions)
...
func (c *FakeStorageBucketIamPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(storagebucketiampoliciesResource, name, pt, data, subresources...), &v1alpha1.StorageBucketIamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageBucketIamPolicy), err
