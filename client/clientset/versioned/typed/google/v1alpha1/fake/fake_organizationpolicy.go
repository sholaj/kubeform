...
func (c *FakeOrganizationPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.OrganizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(organizationpoliciesResource, name), &v1alpha1.OrganizationPolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeOrganizationPolicies) List(opts v1.ListOptions) (result *v1alpha1.OrganizationPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(organizationpoliciesResource, organizationpoliciesKind, opts), &v1alpha1.OrganizationPolicyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeOrganizationPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(organizationpoliciesResource, opts))
}
...
func (c *FakeOrganizationPolicies) Create(organizationPolicy *v1alpha1.OrganizationPolicy) (result *v1alpha1.OrganizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(organizationpoliciesResource, organizationPolicy), &v1alpha1.OrganizationPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.OrganizationPolicy), err
...
func (c *FakeOrganizationPolicies) Update(organizationPolicy *v1alpha1.OrganizationPolicy) (result *v1alpha1.OrganizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(organizationpoliciesResource, organizationPolicy), &v1alpha1.OrganizationPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.OrganizationPolicy), err
...
func (c *FakeOrganizationPolicies) UpdateStatus(organizationPolicy *v1alpha1.OrganizationPolicy) (*v1alpha1.OrganizationPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(organizationpoliciesResource, "status", organizationPolicy), &v1alpha1.OrganizationPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.OrganizationPolicy), err
...
func (c *FakeOrganizationPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(organizationpoliciesResource, name), &v1alpha1.OrganizationPolicy{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeOrganizationPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(organizationpoliciesResource, listOptions)
...
func (c *FakeOrganizationPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OrganizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(organizationpoliciesResource, name, pt, data, subresources...), &v1alpha1.OrganizationPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.OrganizationPolicy), err
