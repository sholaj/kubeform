...
func (c *FakeComputeInstanceGroupManagers) Get(name string, options v1.GetOptions) (result *v1alpha1.ComputeInstanceGroupManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(computeinstancegroupmanagersResource, name), &v1alpha1.ComputeInstanceGroupManager{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComputeInstanceGroupManagers) List(opts v1.ListOptions) (result *v1alpha1.ComputeInstanceGroupManagerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(computeinstancegroupmanagersResource, computeinstancegroupmanagersKind, opts), &v1alpha1.ComputeInstanceGroupManagerList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComputeInstanceGroupManagers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(computeinstancegroupmanagersResource, opts))
}
...
func (c *FakeComputeInstanceGroupManagers) Create(computeInstanceGroupManager *v1alpha1.ComputeInstanceGroupManager) (result *v1alpha1.ComputeInstanceGroupManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(computeinstancegroupmanagersResource, computeInstanceGroupManager), &v1alpha1.ComputeInstanceGroupManager{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeInstanceGroupManager), err
...
func (c *FakeComputeInstanceGroupManagers) Update(computeInstanceGroupManager *v1alpha1.ComputeInstanceGroupManager) (result *v1alpha1.ComputeInstanceGroupManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(computeinstancegroupmanagersResource, computeInstanceGroupManager), &v1alpha1.ComputeInstanceGroupManager{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeInstanceGroupManager), err
...
func (c *FakeComputeInstanceGroupManagers) UpdateStatus(computeInstanceGroupManager *v1alpha1.ComputeInstanceGroupManager) (*v1alpha1.ComputeInstanceGroupManager, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(computeinstancegroupmanagersResource, "status", computeInstanceGroupManager), &v1alpha1.ComputeInstanceGroupManager{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeInstanceGroupManager), err
...
func (c *FakeComputeInstanceGroupManagers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(computeinstancegroupmanagersResource, name), &v1alpha1.ComputeInstanceGroupManager{})
	return err
}
...
func (c *FakeComputeInstanceGroupManagers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(computeinstancegroupmanagersResource, listOptions)
...
func (c *FakeComputeInstanceGroupManagers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ComputeInstanceGroupManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(computeinstancegroupmanagersResource, name, pt, data, subresources...), &v1alpha1.ComputeInstanceGroupManager{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeInstanceGroupManager), err
