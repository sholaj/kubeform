...
func (c *FakeServiceAccountKeys) Get(name string, options v1.GetOptions) (result *v1alpha1.ServiceAccountKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(serviceaccountkeysResource, name), &v1alpha1.ServiceAccountKey{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeServiceAccountKeys) List(opts v1.ListOptions) (result *v1alpha1.ServiceAccountKeyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(serviceaccountkeysResource, serviceaccountkeysKind, opts), &v1alpha1.ServiceAccountKeyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeServiceAccountKeys) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(serviceaccountkeysResource, opts))
}
...
func (c *FakeServiceAccountKeys) Create(serviceAccountKey *v1alpha1.ServiceAccountKey) (result *v1alpha1.ServiceAccountKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(serviceaccountkeysResource, serviceAccountKey), &v1alpha1.ServiceAccountKey{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceAccountKey), err
...
func (c *FakeServiceAccountKeys) Update(serviceAccountKey *v1alpha1.ServiceAccountKey) (result *v1alpha1.ServiceAccountKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(serviceaccountkeysResource, serviceAccountKey), &v1alpha1.ServiceAccountKey{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceAccountKey), err
...
func (c *FakeServiceAccountKeys) UpdateStatus(serviceAccountKey *v1alpha1.ServiceAccountKey) (*v1alpha1.ServiceAccountKey, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(serviceaccountkeysResource, "status", serviceAccountKey), &v1alpha1.ServiceAccountKey{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceAccountKey), err
...
func (c *FakeServiceAccountKeys) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(serviceaccountkeysResource, name), &v1alpha1.ServiceAccountKey{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeServiceAccountKeys) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(serviceaccountkeysResource, listOptions)
...
func (c *FakeServiceAccountKeys) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceAccountKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(serviceaccountkeysResource, name, pt, data, subresources...), &v1alpha1.ServiceAccountKey{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceAccountKey), err
