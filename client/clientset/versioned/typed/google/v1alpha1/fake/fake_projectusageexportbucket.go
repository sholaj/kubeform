...
func (c *FakeProjectUsageExportBuckets) Get(name string, options v1.GetOptions) (result *v1alpha1.ProjectUsageExportBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(projectusageexportbucketsResource, name), &v1alpha1.ProjectUsageExportBucket{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeProjectUsageExportBuckets) List(opts v1.ListOptions) (result *v1alpha1.ProjectUsageExportBucketList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(projectusageexportbucketsResource, projectusageexportbucketsKind, opts), &v1alpha1.ProjectUsageExportBucketList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeProjectUsageExportBuckets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(projectusageexportbucketsResource, opts))
}
...
func (c *FakeProjectUsageExportBuckets) Create(projectUsageExportBucket *v1alpha1.ProjectUsageExportBucket) (result *v1alpha1.ProjectUsageExportBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(projectusageexportbucketsResource, projectUsageExportBucket), &v1alpha1.ProjectUsageExportBucket{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectUsageExportBucket), err
...
func (c *FakeProjectUsageExportBuckets) Update(projectUsageExportBucket *v1alpha1.ProjectUsageExportBucket) (result *v1alpha1.ProjectUsageExportBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(projectusageexportbucketsResource, projectUsageExportBucket), &v1alpha1.ProjectUsageExportBucket{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectUsageExportBucket), err
...
func (c *FakeProjectUsageExportBuckets) UpdateStatus(projectUsageExportBucket *v1alpha1.ProjectUsageExportBucket) (*v1alpha1.ProjectUsageExportBucket, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(projectusageexportbucketsResource, "status", projectUsageExportBucket), &v1alpha1.ProjectUsageExportBucket{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectUsageExportBucket), err
...
func (c *FakeProjectUsageExportBuckets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(projectusageexportbucketsResource, name), &v1alpha1.ProjectUsageExportBucket{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeProjectUsageExportBuckets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(projectusageexportbucketsResource, listOptions)
...
func (c *FakeProjectUsageExportBuckets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ProjectUsageExportBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(projectusageexportbucketsResource, name, pt, data, subresources...), &v1alpha1.ProjectUsageExportBucket{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectUsageExportBucket), err
