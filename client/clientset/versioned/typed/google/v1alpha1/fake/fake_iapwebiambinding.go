...
func (c *FakeIapWebIamBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.IapWebIamBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapWebIamBindings) List(opts v1.ListOptions) (result *v1alpha1.IapWebIamBindingList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapWebIamBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeIapWebIamBindings) Create(iapWebIamBinding *v1alpha1.IapWebIamBinding) (result *v1alpha1.IapWebIamBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapWebIamBindings) Update(iapWebIamBinding *v1alpha1.IapWebIamBinding) (result *v1alpha1.IapWebIamBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapWebIamBindings) UpdateStatus(iapWebIamBinding *v1alpha1.IapWebIamBinding) (*v1alpha1.IapWebIamBinding, error) {
	obj, err := c.Fake.
...
func (c *FakeIapWebIamBindings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeIapWebIamBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iapwebiambindingsResource, c.ns, listOptions)
...
func (c *FakeIapWebIamBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IapWebIamBinding, err error) {
	obj, err := c.Fake.
