...
func (c *FakeComputeRouterPeers) Get(name string, options v1.GetOptions) (result *v1alpha1.ComputeRouterPeer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(computerouterpeersResource, name), &v1alpha1.ComputeRouterPeer{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComputeRouterPeers) List(opts v1.ListOptions) (result *v1alpha1.ComputeRouterPeerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(computerouterpeersResource, computerouterpeersKind, opts), &v1alpha1.ComputeRouterPeerList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComputeRouterPeers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(computerouterpeersResource, opts))
}
...
func (c *FakeComputeRouterPeers) Create(computeRouterPeer *v1alpha1.ComputeRouterPeer) (result *v1alpha1.ComputeRouterPeer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(computerouterpeersResource, computeRouterPeer), &v1alpha1.ComputeRouterPeer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeRouterPeer), err
...
func (c *FakeComputeRouterPeers) Update(computeRouterPeer *v1alpha1.ComputeRouterPeer) (result *v1alpha1.ComputeRouterPeer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(computerouterpeersResource, computeRouterPeer), &v1alpha1.ComputeRouterPeer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeRouterPeer), err
...
func (c *FakeComputeRouterPeers) UpdateStatus(computeRouterPeer *v1alpha1.ComputeRouterPeer) (*v1alpha1.ComputeRouterPeer, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(computerouterpeersResource, "status", computeRouterPeer), &v1alpha1.ComputeRouterPeer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeRouterPeer), err
...
func (c *FakeComputeRouterPeers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(computerouterpeersResource, name), &v1alpha1.ComputeRouterPeer{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeComputeRouterPeers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(computerouterpeersResource, listOptions)
...
func (c *FakeComputeRouterPeers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ComputeRouterPeer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(computerouterpeersResource, name, pt, data, subresources...), &v1alpha1.ComputeRouterPeer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ComputeRouterPeer), err
