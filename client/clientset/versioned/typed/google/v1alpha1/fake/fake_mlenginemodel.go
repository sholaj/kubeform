...
func (c *FakeMlEngineModels) Get(name string, options v1.GetOptions) (result *v1alpha1.MlEngineModel, err error) {
	obj, err := c.Fake.
...
func (c *FakeMlEngineModels) List(opts v1.ListOptions) (result *v1alpha1.MlEngineModelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMlEngineModels) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeMlEngineModels) Create(mlEngineModel *v1alpha1.MlEngineModel) (result *v1alpha1.MlEngineModel, err error) {
	obj, err := c.Fake.
...
func (c *FakeMlEngineModels) Update(mlEngineModel *v1alpha1.MlEngineModel) (result *v1alpha1.MlEngineModel, err error) {
	obj, err := c.Fake.
...
func (c *FakeMlEngineModels) UpdateStatus(mlEngineModel *v1alpha1.MlEngineModel) (*v1alpha1.MlEngineModel, error) {
	obj, err := c.Fake.
...
func (c *FakeMlEngineModels) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeMlEngineModels) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(mlenginemodelsResource, c.ns, listOptions)
...
func (c *FakeMlEngineModels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MlEngineModel, err error) {
	obj, err := c.Fake.
