...
func (c *FakeComputeDiskResourcePolicyAttachments) Get(name string, options v1.GetOptions) (result *v1alpha1.ComputeDiskResourcePolicyAttachment, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeDiskResourcePolicyAttachments) List(opts v1.ListOptions) (result *v1alpha1.ComputeDiskResourcePolicyAttachmentList, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeDiskResourcePolicyAttachments) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeComputeDiskResourcePolicyAttachments) Create(computeDiskResourcePolicyAttachment *v1alpha1.ComputeDiskResourcePolicyAttachment) (result *v1alpha1.ComputeDiskResourcePolicyAttachment, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeDiskResourcePolicyAttachments) Update(computeDiskResourcePolicyAttachment *v1alpha1.ComputeDiskResourcePolicyAttachment) (result *v1alpha1.ComputeDiskResourcePolicyAttachment, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeDiskResourcePolicyAttachments) UpdateStatus(computeDiskResourcePolicyAttachment *v1alpha1.ComputeDiskResourcePolicyAttachment) (*v1alpha1.ComputeDiskResourcePolicyAttachment, error) {
	obj, err := c.Fake.
...
func (c *FakeComputeDiskResourcePolicyAttachments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeComputeDiskResourcePolicyAttachments) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(computediskresourcepolicyattachmentsResource, c.ns, listOptions)
...
func (c *FakeComputeDiskResourcePolicyAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ComputeDiskResourcePolicyAttachment, err error) {
	obj, err := c.Fake.
