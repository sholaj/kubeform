...
func (c *FakeIapAppEngineVersionIamMembers) Get(name string, options v1.GetOptions) (result *v1alpha1.IapAppEngineVersionIamMember, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineVersionIamMembers) List(opts v1.ListOptions) (result *v1alpha1.IapAppEngineVersionIamMemberList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineVersionIamMembers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeIapAppEngineVersionIamMembers) Create(iapAppEngineVersionIamMember *v1alpha1.IapAppEngineVersionIamMember) (result *v1alpha1.IapAppEngineVersionIamMember, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineVersionIamMembers) Update(iapAppEngineVersionIamMember *v1alpha1.IapAppEngineVersionIamMember) (result *v1alpha1.IapAppEngineVersionIamMember, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineVersionIamMembers) UpdateStatus(iapAppEngineVersionIamMember *v1alpha1.IapAppEngineVersionIamMember) (*v1alpha1.IapAppEngineVersionIamMember, error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineVersionIamMembers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeIapAppEngineVersionIamMembers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iapappengineversioniammembersResource, c.ns, listOptions)
...
func (c *FakeIapAppEngineVersionIamMembers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IapAppEngineVersionIamMember, err error) {
	obj, err := c.Fake.
