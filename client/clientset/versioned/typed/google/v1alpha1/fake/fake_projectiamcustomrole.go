...
func (c *FakeProjectIamCustomRoles) Get(name string, options v1.GetOptions) (result *v1alpha1.ProjectIamCustomRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(projectiamcustomrolesResource, name), &v1alpha1.ProjectIamCustomRole{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeProjectIamCustomRoles) List(opts v1.ListOptions) (result *v1alpha1.ProjectIamCustomRoleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(projectiamcustomrolesResource, projectiamcustomrolesKind, opts), &v1alpha1.ProjectIamCustomRoleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeProjectIamCustomRoles) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(projectiamcustomrolesResource, opts))
}
...
func (c *FakeProjectIamCustomRoles) Create(projectIamCustomRole *v1alpha1.ProjectIamCustomRole) (result *v1alpha1.ProjectIamCustomRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(projectiamcustomrolesResource, projectIamCustomRole), &v1alpha1.ProjectIamCustomRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectIamCustomRole), err
...
func (c *FakeProjectIamCustomRoles) Update(projectIamCustomRole *v1alpha1.ProjectIamCustomRole) (result *v1alpha1.ProjectIamCustomRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(projectiamcustomrolesResource, projectIamCustomRole), &v1alpha1.ProjectIamCustomRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectIamCustomRole), err
...
func (c *FakeProjectIamCustomRoles) UpdateStatus(projectIamCustomRole *v1alpha1.ProjectIamCustomRole) (*v1alpha1.ProjectIamCustomRole, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(projectiamcustomrolesResource, "status", projectIamCustomRole), &v1alpha1.ProjectIamCustomRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectIamCustomRole), err
...
func (c *FakeProjectIamCustomRoles) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(projectiamcustomrolesResource, name), &v1alpha1.ProjectIamCustomRole{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeProjectIamCustomRoles) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(projectiamcustomrolesResource, listOptions)
...
func (c *FakeProjectIamCustomRoles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ProjectIamCustomRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(projectiamcustomrolesResource, name, pt, data, subresources...), &v1alpha1.ProjectIamCustomRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ProjectIamCustomRole), err
