...
func (c *FakeRedisInstances) Get(name string, options v1.GetOptions) (result *v1alpha1.RedisInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(redisinstancesResource, name), &v1alpha1.RedisInstance{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeRedisInstances) List(opts v1.ListOptions) (result *v1alpha1.RedisInstanceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(redisinstancesResource, redisinstancesKind, opts), &v1alpha1.RedisInstanceList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeRedisInstances) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(redisinstancesResource, opts))
}
...
func (c *FakeRedisInstances) Create(redisInstance *v1alpha1.RedisInstance) (result *v1alpha1.RedisInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(redisinstancesResource, redisInstance), &v1alpha1.RedisInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RedisInstance), err
...
func (c *FakeRedisInstances) Update(redisInstance *v1alpha1.RedisInstance) (result *v1alpha1.RedisInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(redisinstancesResource, redisInstance), &v1alpha1.RedisInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RedisInstance), err
...
func (c *FakeRedisInstances) UpdateStatus(redisInstance *v1alpha1.RedisInstance) (*v1alpha1.RedisInstance, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(redisinstancesResource, "status", redisInstance), &v1alpha1.RedisInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RedisInstance), err
...
func (c *FakeRedisInstances) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(redisinstancesResource, name), &v1alpha1.RedisInstance{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeRedisInstances) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(redisinstancesResource, listOptions)
...
func (c *FakeRedisInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.RedisInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(redisinstancesResource, name, pt, data, subresources...), &v1alpha1.RedisInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RedisInstance), err
