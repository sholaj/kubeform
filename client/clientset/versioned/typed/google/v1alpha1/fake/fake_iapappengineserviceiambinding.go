...
func (c *FakeIapAppEngineServiceIamBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineServiceIamBindings) List(opts v1.ListOptions) (result *v1alpha1.IapAppEngineServiceIamBindingList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineServiceIamBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeIapAppEngineServiceIamBindings) Create(iapAppEngineServiceIamBinding *v1alpha1.IapAppEngineServiceIamBinding) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineServiceIamBindings) Update(iapAppEngineServiceIamBinding *v1alpha1.IapAppEngineServiceIamBinding) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineServiceIamBindings) UpdateStatus(iapAppEngineServiceIamBinding *v1alpha1.IapAppEngineServiceIamBinding) (*v1alpha1.IapAppEngineServiceIamBinding, error) {
	obj, err := c.Fake.
...
func (c *FakeIapAppEngineServiceIamBindings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeIapAppEngineServiceIamBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iapappengineserviceiambindingsResource, c.ns, listOptions)
...
func (c *FakeIapAppEngineServiceIamBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	obj, err := c.Fake.
