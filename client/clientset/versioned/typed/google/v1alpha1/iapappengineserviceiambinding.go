...
type IapAppEngineServiceIamBindingInterface interface {
	Create(*v1alpha1.IapAppEngineServiceIamBinding) (*v1alpha1.IapAppEngineServiceIamBinding, error)
	Update(*v1alpha1.IapAppEngineServiceIamBinding) (*v1alpha1.IapAppEngineServiceIamBinding, error)
	UpdateStatus(*v1alpha1.IapAppEngineServiceIamBinding) (*v1alpha1.IapAppEngineServiceIamBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.IapAppEngineServiceIamBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.IapAppEngineServiceIamBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IapAppEngineServiceIamBinding, err error)
...
func (c *iapAppEngineServiceIamBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
...
func (c *iapAppEngineServiceIamBindings) List(opts v1.ListOptions) (result *v1alpha1.IapAppEngineServiceIamBindingList, err error) {
...
func (c *iapAppEngineServiceIamBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iapAppEngineServiceIamBindings) Create(iapAppEngineServiceIamBinding *v1alpha1.IapAppEngineServiceIamBinding) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	result = &v1alpha1.IapAppEngineServiceIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iapappengineserviceiambindings").
...
func (c *iapAppEngineServiceIamBindings) Update(iapAppEngineServiceIamBinding *v1alpha1.IapAppEngineServiceIamBinding) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	result = &v1alpha1.IapAppEngineServiceIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iapappengineserviceiambindings").
...
func (c *iapAppEngineServiceIamBindings) UpdateStatus(iapAppEngineServiceIamBinding *v1alpha1.IapAppEngineServiceIamBinding) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	result = &v1alpha1.IapAppEngineServiceIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iapappengineserviceiambindings").
...
func (c *iapAppEngineServiceIamBindings) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *iapAppEngineServiceIamBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iapAppEngineServiceIamBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IapAppEngineServiceIamBinding, err error) {
	result = &v1alpha1.IapAppEngineServiceIamBinding{}
