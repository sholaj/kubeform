...
func (c *FakeSesEmailIdentities) Get(name string, options v1.GetOptions) (result *v1alpha1.SesEmailIdentity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(sesemailidentitiesResource, name), &v1alpha1.SesEmailIdentity{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSesEmailIdentities) List(opts v1.ListOptions) (result *v1alpha1.SesEmailIdentityList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(sesemailidentitiesResource, sesemailidentitiesKind, opts), &v1alpha1.SesEmailIdentityList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSesEmailIdentities) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(sesemailidentitiesResource, opts))
}
...
func (c *FakeSesEmailIdentities) Create(sesEmailIdentity *v1alpha1.SesEmailIdentity) (result *v1alpha1.SesEmailIdentity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(sesemailidentitiesResource, sesEmailIdentity), &v1alpha1.SesEmailIdentity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesEmailIdentity), err
...
func (c *FakeSesEmailIdentities) Update(sesEmailIdentity *v1alpha1.SesEmailIdentity) (result *v1alpha1.SesEmailIdentity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(sesemailidentitiesResource, sesEmailIdentity), &v1alpha1.SesEmailIdentity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesEmailIdentity), err
...
func (c *FakeSesEmailIdentities) UpdateStatus(sesEmailIdentity *v1alpha1.SesEmailIdentity) (*v1alpha1.SesEmailIdentity, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(sesemailidentitiesResource, "status", sesEmailIdentity), &v1alpha1.SesEmailIdentity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesEmailIdentity), err
...
func (c *FakeSesEmailIdentities) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(sesemailidentitiesResource, name), &v1alpha1.SesEmailIdentity{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeSesEmailIdentities) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(sesemailidentitiesResource, listOptions)
...
func (c *FakeSesEmailIdentities) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SesEmailIdentity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(sesemailidentitiesResource, name, pt, data, subresources...), &v1alpha1.SesEmailIdentity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesEmailIdentity), err
