...
func (c *FakeS3BucketPublicAccessBlocks) Get(name string, options v1.GetOptions) (result *v1alpha1.S3BucketPublicAccessBlock, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(s3bucketpublicaccessblocksResource, name), &v1alpha1.S3BucketPublicAccessBlock{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeS3BucketPublicAccessBlocks) List(opts v1.ListOptions) (result *v1alpha1.S3BucketPublicAccessBlockList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(s3bucketpublicaccessblocksResource, s3bucketpublicaccessblocksKind, opts), &v1alpha1.S3BucketPublicAccessBlockList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeS3BucketPublicAccessBlocks) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(s3bucketpublicaccessblocksResource, opts))
}
...
func (c *FakeS3BucketPublicAccessBlocks) Create(s3BucketPublicAccessBlock *v1alpha1.S3BucketPublicAccessBlock) (result *v1alpha1.S3BucketPublicAccessBlock, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(s3bucketpublicaccessblocksResource, s3BucketPublicAccessBlock), &v1alpha1.S3BucketPublicAccessBlock{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.S3BucketPublicAccessBlock), err
...
func (c *FakeS3BucketPublicAccessBlocks) Update(s3BucketPublicAccessBlock *v1alpha1.S3BucketPublicAccessBlock) (result *v1alpha1.S3BucketPublicAccessBlock, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(s3bucketpublicaccessblocksResource, s3BucketPublicAccessBlock), &v1alpha1.S3BucketPublicAccessBlock{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.S3BucketPublicAccessBlock), err
...
func (c *FakeS3BucketPublicAccessBlocks) UpdateStatus(s3BucketPublicAccessBlock *v1alpha1.S3BucketPublicAccessBlock) (*v1alpha1.S3BucketPublicAccessBlock, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(s3bucketpublicaccessblocksResource, "status", s3BucketPublicAccessBlock), &v1alpha1.S3BucketPublicAccessBlock{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.S3BucketPublicAccessBlock), err
...
func (c *FakeS3BucketPublicAccessBlocks) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(s3bucketpublicaccessblocksResource, name), &v1alpha1.S3BucketPublicAccessBlock{})
	return err
}
...
func (c *FakeS3BucketPublicAccessBlocks) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(s3bucketpublicaccessblocksResource, listOptions)
...
func (c *FakeS3BucketPublicAccessBlocks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.S3BucketPublicAccessBlock, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(s3bucketpublicaccessblocksResource, name, pt, data, subresources...), &v1alpha1.S3BucketPublicAccessBlock{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.S3BucketPublicAccessBlock), err
