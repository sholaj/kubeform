...
func (c *FakeIotCertificates) Get(name string, options v1.GetOptions) (result *v1alpha1.IotCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(iotcertificatesResource, name), &v1alpha1.IotCertificate{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeIotCertificates) List(opts v1.ListOptions) (result *v1alpha1.IotCertificateList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(iotcertificatesResource, iotcertificatesKind, opts), &v1alpha1.IotCertificateList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeIotCertificates) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(iotcertificatesResource, opts))
}
...
func (c *FakeIotCertificates) Create(iotCertificate *v1alpha1.IotCertificate) (result *v1alpha1.IotCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(iotcertificatesResource, iotCertificate), &v1alpha1.IotCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IotCertificate), err
...
func (c *FakeIotCertificates) Update(iotCertificate *v1alpha1.IotCertificate) (result *v1alpha1.IotCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(iotcertificatesResource, iotCertificate), &v1alpha1.IotCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IotCertificate), err
...
func (c *FakeIotCertificates) UpdateStatus(iotCertificate *v1alpha1.IotCertificate) (*v1alpha1.IotCertificate, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(iotcertificatesResource, "status", iotCertificate), &v1alpha1.IotCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IotCertificate), err
...
func (c *FakeIotCertificates) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(iotcertificatesResource, name), &v1alpha1.IotCertificate{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeIotCertificates) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(iotcertificatesResource, listOptions)
...
func (c *FakeIotCertificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IotCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(iotcertificatesResource, name, pt, data, subresources...), &v1alpha1.IotCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IotCertificate), err
