...
func (c *FakeCognitoIdentityProviders) Get(name string, options v1.GetOptions) (result *v1alpha1.CognitoIdentityProvider, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(cognitoidentityprovidersResource, name), &v1alpha1.CognitoIdentityProvider{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCognitoIdentityProviders) List(opts v1.ListOptions) (result *v1alpha1.CognitoIdentityProviderList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(cognitoidentityprovidersResource, cognitoidentityprovidersKind, opts), &v1alpha1.CognitoIdentityProviderList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCognitoIdentityProviders) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(cognitoidentityprovidersResource, opts))
}
...
func (c *FakeCognitoIdentityProviders) Create(cognitoIdentityProvider *v1alpha1.CognitoIdentityProvider) (result *v1alpha1.CognitoIdentityProvider, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(cognitoidentityprovidersResource, cognitoIdentityProvider), &v1alpha1.CognitoIdentityProvider{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CognitoIdentityProvider), err
...
func (c *FakeCognitoIdentityProviders) Update(cognitoIdentityProvider *v1alpha1.CognitoIdentityProvider) (result *v1alpha1.CognitoIdentityProvider, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(cognitoidentityprovidersResource, cognitoIdentityProvider), &v1alpha1.CognitoIdentityProvider{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CognitoIdentityProvider), err
...
func (c *FakeCognitoIdentityProviders) UpdateStatus(cognitoIdentityProvider *v1alpha1.CognitoIdentityProvider) (*v1alpha1.CognitoIdentityProvider, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(cognitoidentityprovidersResource, "status", cognitoIdentityProvider), &v1alpha1.CognitoIdentityProvider{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CognitoIdentityProvider), err
...
func (c *FakeCognitoIdentityProviders) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(cognitoidentityprovidersResource, name), &v1alpha1.CognitoIdentityProvider{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeCognitoIdentityProviders) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(cognitoidentityprovidersResource, listOptions)
...
func (c *FakeCognitoIdentityProviders) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CognitoIdentityProvider, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(cognitoidentityprovidersResource, name, pt, data, subresources...), &v1alpha1.CognitoIdentityProvider{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CognitoIdentityProvider), err
