...
func (c *FakeElasticsearchDomainPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.ElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(elasticsearchdomainpoliciesResource, name), &v1alpha1.ElasticsearchDomainPolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeElasticsearchDomainPolicies) List(opts v1.ListOptions) (result *v1alpha1.ElasticsearchDomainPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(elasticsearchdomainpoliciesResource, elasticsearchdomainpoliciesKind, opts), &v1alpha1.ElasticsearchDomainPolicyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeElasticsearchDomainPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(elasticsearchdomainpoliciesResource, opts))
}
...
func (c *FakeElasticsearchDomainPolicies) Create(elasticsearchDomainPolicy *v1alpha1.ElasticsearchDomainPolicy) (result *v1alpha1.ElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(elasticsearchdomainpoliciesResource, elasticsearchDomainPolicy), &v1alpha1.ElasticsearchDomainPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticsearchDomainPolicy), err
...
func (c *FakeElasticsearchDomainPolicies) Update(elasticsearchDomainPolicy *v1alpha1.ElasticsearchDomainPolicy) (result *v1alpha1.ElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(elasticsearchdomainpoliciesResource, elasticsearchDomainPolicy), &v1alpha1.ElasticsearchDomainPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticsearchDomainPolicy), err
...
func (c *FakeElasticsearchDomainPolicies) UpdateStatus(elasticsearchDomainPolicy *v1alpha1.ElasticsearchDomainPolicy) (*v1alpha1.ElasticsearchDomainPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(elasticsearchdomainpoliciesResource, "status", elasticsearchDomainPolicy), &v1alpha1.ElasticsearchDomainPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticsearchDomainPolicy), err
...
func (c *FakeElasticsearchDomainPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(elasticsearchdomainpoliciesResource, name), &v1alpha1.ElasticsearchDomainPolicy{})
	return err
}
...
func (c *FakeElasticsearchDomainPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(elasticsearchdomainpoliciesResource, listOptions)
...
func (c *FakeElasticsearchDomainPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(elasticsearchdomainpoliciesResource, name, pt, data, subresources...), &v1alpha1.ElasticsearchDomainPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticsearchDomainPolicy), err
