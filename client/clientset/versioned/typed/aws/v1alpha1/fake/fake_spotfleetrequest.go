...
func (c *FakeSpotFleetRequests) Get(name string, options v1.GetOptions) (result *v1alpha1.SpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(spotfleetrequestsResource, name), &v1alpha1.SpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSpotFleetRequests) List(opts v1.ListOptions) (result *v1alpha1.SpotFleetRequestList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(spotfleetrequestsResource, spotfleetrequestsKind, opts), &v1alpha1.SpotFleetRequestList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSpotFleetRequests) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(spotfleetrequestsResource, opts))
}
...
func (c *FakeSpotFleetRequests) Create(spotFleetRequest *v1alpha1.SpotFleetRequest) (result *v1alpha1.SpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(spotfleetrequestsResource, spotFleetRequest), &v1alpha1.SpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SpotFleetRequest), err
...
func (c *FakeSpotFleetRequests) Update(spotFleetRequest *v1alpha1.SpotFleetRequest) (result *v1alpha1.SpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(spotfleetrequestsResource, spotFleetRequest), &v1alpha1.SpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SpotFleetRequest), err
...
func (c *FakeSpotFleetRequests) UpdateStatus(spotFleetRequest *v1alpha1.SpotFleetRequest) (*v1alpha1.SpotFleetRequest, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(spotfleetrequestsResource, "status", spotFleetRequest), &v1alpha1.SpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SpotFleetRequest), err
...
func (c *FakeSpotFleetRequests) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(spotfleetrequestsResource, name), &v1alpha1.SpotFleetRequest{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeSpotFleetRequests) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(spotfleetrequestsResource, listOptions)
...
func (c *FakeSpotFleetRequests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(spotfleetrequestsResource, name, pt, data, subresources...), &v1alpha1.SpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SpotFleetRequest), err
