...
func (c *FakeWafregionalRules) Get(name string, options v1.GetOptions) (result *v1alpha1.WafregionalRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(wafregionalrulesResource, name), &v1alpha1.WafregionalRule{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeWafregionalRules) List(opts v1.ListOptions) (result *v1alpha1.WafregionalRuleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(wafregionalrulesResource, wafregionalrulesKind, opts), &v1alpha1.WafregionalRuleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeWafregionalRules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(wafregionalrulesResource, opts))
}
...
func (c *FakeWafregionalRules) Create(wafregionalRule *v1alpha1.WafregionalRule) (result *v1alpha1.WafregionalRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(wafregionalrulesResource, wafregionalRule), &v1alpha1.WafregionalRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.WafregionalRule), err
...
func (c *FakeWafregionalRules) Update(wafregionalRule *v1alpha1.WafregionalRule) (result *v1alpha1.WafregionalRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(wafregionalrulesResource, wafregionalRule), &v1alpha1.WafregionalRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.WafregionalRule), err
...
func (c *FakeWafregionalRules) UpdateStatus(wafregionalRule *v1alpha1.WafregionalRule) (*v1alpha1.WafregionalRule, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(wafregionalrulesResource, "status", wafregionalRule), &v1alpha1.WafregionalRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.WafregionalRule), err
...
func (c *FakeWafregionalRules) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(wafregionalrulesResource, name), &v1alpha1.WafregionalRule{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeWafregionalRules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(wafregionalrulesResource, listOptions)
...
func (c *FakeWafregionalRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.WafregionalRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(wafregionalrulesResource, name, pt, data, subresources...), &v1alpha1.WafregionalRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.WafregionalRule), err
