...
func (c *FakeApiGatewayIntegrations) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayIntegration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(apigatewayintegrationsResource, name), &v1alpha1.ApiGatewayIntegration{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiGatewayIntegrations) List(opts v1.ListOptions) (result *v1alpha1.ApiGatewayIntegrationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(apigatewayintegrationsResource, apigatewayintegrationsKind, opts), &v1alpha1.ApiGatewayIntegrationList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiGatewayIntegrations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(apigatewayintegrationsResource, opts))
}
...
func (c *FakeApiGatewayIntegrations) Create(apiGatewayIntegration *v1alpha1.ApiGatewayIntegration) (result *v1alpha1.ApiGatewayIntegration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(apigatewayintegrationsResource, apiGatewayIntegration), &v1alpha1.ApiGatewayIntegration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayIntegration), err
...
func (c *FakeApiGatewayIntegrations) Update(apiGatewayIntegration *v1alpha1.ApiGatewayIntegration) (result *v1alpha1.ApiGatewayIntegration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(apigatewayintegrationsResource, apiGatewayIntegration), &v1alpha1.ApiGatewayIntegration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayIntegration), err
...
func (c *FakeApiGatewayIntegrations) UpdateStatus(apiGatewayIntegration *v1alpha1.ApiGatewayIntegration) (*v1alpha1.ApiGatewayIntegration, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(apigatewayintegrationsResource, "status", apiGatewayIntegration), &v1alpha1.ApiGatewayIntegration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayIntegration), err
...
func (c *FakeApiGatewayIntegrations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(apigatewayintegrationsResource, name), &v1alpha1.ApiGatewayIntegration{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeApiGatewayIntegrations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(apigatewayintegrationsResource, listOptions)
...
func (c *FakeApiGatewayIntegrations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiGatewayIntegration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apigatewayintegrationsResource, name, pt, data, subresources...), &v1alpha1.ApiGatewayIntegration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayIntegration), err
