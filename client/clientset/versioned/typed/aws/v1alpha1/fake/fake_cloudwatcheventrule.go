...
func (c *FakeCloudwatchEventRules) Get(name string, options v1.GetOptions) (result *v1alpha1.CloudwatchEventRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(cloudwatcheventrulesResource, name), &v1alpha1.CloudwatchEventRule{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCloudwatchEventRules) List(opts v1.ListOptions) (result *v1alpha1.CloudwatchEventRuleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(cloudwatcheventrulesResource, cloudwatcheventrulesKind, opts), &v1alpha1.CloudwatchEventRuleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCloudwatchEventRules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(cloudwatcheventrulesResource, opts))
}
...
func (c *FakeCloudwatchEventRules) Create(cloudwatchEventRule *v1alpha1.CloudwatchEventRule) (result *v1alpha1.CloudwatchEventRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(cloudwatcheventrulesResource, cloudwatchEventRule), &v1alpha1.CloudwatchEventRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CloudwatchEventRule), err
...
func (c *FakeCloudwatchEventRules) Update(cloudwatchEventRule *v1alpha1.CloudwatchEventRule) (result *v1alpha1.CloudwatchEventRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(cloudwatcheventrulesResource, cloudwatchEventRule), &v1alpha1.CloudwatchEventRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CloudwatchEventRule), err
...
func (c *FakeCloudwatchEventRules) UpdateStatus(cloudwatchEventRule *v1alpha1.CloudwatchEventRule) (*v1alpha1.CloudwatchEventRule, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(cloudwatcheventrulesResource, "status", cloudwatchEventRule), &v1alpha1.CloudwatchEventRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CloudwatchEventRule), err
...
func (c *FakeCloudwatchEventRules) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(cloudwatcheventrulesResource, name), &v1alpha1.CloudwatchEventRule{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeCloudwatchEventRules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(cloudwatcheventrulesResource, listOptions)
...
func (c *FakeCloudwatchEventRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CloudwatchEventRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(cloudwatcheventrulesResource, name, pt, data, subresources...), &v1alpha1.CloudwatchEventRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CloudwatchEventRule), err
