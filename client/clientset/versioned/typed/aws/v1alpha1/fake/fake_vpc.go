...
func (c *FakeVpcs) Get(name string, options v1.GetOptions) (result *v1alpha1.Vpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(vpcsResource, name), &v1alpha1.Vpc{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVpcs) List(opts v1.ListOptions) (result *v1alpha1.VpcList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(vpcsResource, vpcsKind, opts), &v1alpha1.VpcList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVpcs) Create(vpc *v1alpha1.Vpc) (result *v1alpha1.Vpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(vpcsResource, vpc), &v1alpha1.Vpc{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Vpc), err
...
func (c *FakeVpcs) Update(vpc *v1alpha1.Vpc) (result *v1alpha1.Vpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(vpcsResource, vpc), &v1alpha1.Vpc{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Vpc), err
...
func (c *FakeVpcs) UpdateStatus(vpc *v1alpha1.Vpc) (*v1alpha1.Vpc, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(vpcsResource, "status", vpc), &v1alpha1.Vpc{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Vpc), err
...
func (c *FakeVpcs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(vpcsResource, name), &v1alpha1.Vpc{})
	return err
}
...
func (c *FakeVpcs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Vpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(vpcsResource, name, pt, data, subresources...), &v1alpha1.Vpc{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Vpc), err
