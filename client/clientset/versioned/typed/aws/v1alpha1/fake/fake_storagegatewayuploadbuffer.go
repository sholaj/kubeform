...
func (c *FakeStoragegatewayUploadBuffers) Get(name string, options v1.GetOptions) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(storagegatewayuploadbuffersResource, name), &v1alpha1.StoragegatewayUploadBuffer{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStoragegatewayUploadBuffers) List(opts v1.ListOptions) (result *v1alpha1.StoragegatewayUploadBufferList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(storagegatewayuploadbuffersResource, storagegatewayuploadbuffersKind, opts), &v1alpha1.StoragegatewayUploadBufferList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStoragegatewayUploadBuffers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(storagegatewayuploadbuffersResource, opts))
}
...
func (c *FakeStoragegatewayUploadBuffers) Create(storagegatewayUploadBuffer *v1alpha1.StoragegatewayUploadBuffer) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(storagegatewayuploadbuffersResource, storagegatewayUploadBuffer), &v1alpha1.StoragegatewayUploadBuffer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StoragegatewayUploadBuffer), err
...
func (c *FakeStoragegatewayUploadBuffers) Update(storagegatewayUploadBuffer *v1alpha1.StoragegatewayUploadBuffer) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(storagegatewayuploadbuffersResource, storagegatewayUploadBuffer), &v1alpha1.StoragegatewayUploadBuffer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StoragegatewayUploadBuffer), err
...
func (c *FakeStoragegatewayUploadBuffers) UpdateStatus(storagegatewayUploadBuffer *v1alpha1.StoragegatewayUploadBuffer) (*v1alpha1.StoragegatewayUploadBuffer, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(storagegatewayuploadbuffersResource, "status", storagegatewayUploadBuffer), &v1alpha1.StoragegatewayUploadBuffer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StoragegatewayUploadBuffer), err
...
func (c *FakeStoragegatewayUploadBuffers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(storagegatewayuploadbuffersResource, name), &v1alpha1.StoragegatewayUploadBuffer{})
	return err
}
...
func (c *FakeStoragegatewayUploadBuffers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(storagegatewayuploadbuffersResource, listOptions)
...
func (c *FakeStoragegatewayUploadBuffers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(storagegatewayuploadbuffersResource, name, pt, data, subresources...), &v1alpha1.StoragegatewayUploadBuffer{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StoragegatewayUploadBuffer), err
