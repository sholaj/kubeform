...
var postgresversionsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "postgresversions"}

var postgresversionsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "PostgresVersion"}
...
func (c *FakePostgresVersions) UpdateStatus(postgresVersion *v1alpha1.PostgresVersion) (*v1alpha1.PostgresVersion, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(postgresversionsResource, "status", postgresVersion), &v1alpha1.PostgresVersion{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.PostgresVersion), err
