...
func (c *FakeDocdbClusterSnapshots) Get(name string, options v1.GetOptions) (result *v1alpha1.DocdbClusterSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(docdbclustersnapshotsResource, name), &v1alpha1.DocdbClusterSnapshot{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDocdbClusterSnapshots) List(opts v1.ListOptions) (result *v1alpha1.DocdbClusterSnapshotList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(docdbclustersnapshotsResource, docdbclustersnapshotsKind, opts), &v1alpha1.DocdbClusterSnapshotList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDocdbClusterSnapshots) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(docdbclustersnapshotsResource, opts))
}
...
func (c *FakeDocdbClusterSnapshots) Create(docdbClusterSnapshot *v1alpha1.DocdbClusterSnapshot) (result *v1alpha1.DocdbClusterSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(docdbclustersnapshotsResource, docdbClusterSnapshot), &v1alpha1.DocdbClusterSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterSnapshot), err
...
func (c *FakeDocdbClusterSnapshots) Update(docdbClusterSnapshot *v1alpha1.DocdbClusterSnapshot) (result *v1alpha1.DocdbClusterSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(docdbclustersnapshotsResource, docdbClusterSnapshot), &v1alpha1.DocdbClusterSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterSnapshot), err
...
func (c *FakeDocdbClusterSnapshots) UpdateStatus(docdbClusterSnapshot *v1alpha1.DocdbClusterSnapshot) (*v1alpha1.DocdbClusterSnapshot, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(docdbclustersnapshotsResource, "status", docdbClusterSnapshot), &v1alpha1.DocdbClusterSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterSnapshot), err
...
func (c *FakeDocdbClusterSnapshots) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(docdbclustersnapshotsResource, name), &v1alpha1.DocdbClusterSnapshot{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeDocdbClusterSnapshots) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(docdbclustersnapshotsResource, listOptions)
...
func (c *FakeDocdbClusterSnapshots) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DocdbClusterSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(docdbclustersnapshotsResource, name, pt, data, subresources...), &v1alpha1.DocdbClusterSnapshot{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterSnapshot), err
