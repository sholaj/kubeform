...
func (c *FakeDocdbClusterParameterGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.DocdbClusterParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(docdbclusterparametergroupsResource, name), &v1alpha1.DocdbClusterParameterGroup{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDocdbClusterParameterGroups) List(opts v1.ListOptions) (result *v1alpha1.DocdbClusterParameterGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(docdbclusterparametergroupsResource, docdbclusterparametergroupsKind, opts), &v1alpha1.DocdbClusterParameterGroupList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDocdbClusterParameterGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(docdbclusterparametergroupsResource, opts))
}
...
func (c *FakeDocdbClusterParameterGroups) Create(docdbClusterParameterGroup *v1alpha1.DocdbClusterParameterGroup) (result *v1alpha1.DocdbClusterParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(docdbclusterparametergroupsResource, docdbClusterParameterGroup), &v1alpha1.DocdbClusterParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterParameterGroup), err
...
func (c *FakeDocdbClusterParameterGroups) Update(docdbClusterParameterGroup *v1alpha1.DocdbClusterParameterGroup) (result *v1alpha1.DocdbClusterParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(docdbclusterparametergroupsResource, docdbClusterParameterGroup), &v1alpha1.DocdbClusterParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterParameterGroup), err
...
func (c *FakeDocdbClusterParameterGroups) UpdateStatus(docdbClusterParameterGroup *v1alpha1.DocdbClusterParameterGroup) (*v1alpha1.DocdbClusterParameterGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(docdbclusterparametergroupsResource, "status", docdbClusterParameterGroup), &v1alpha1.DocdbClusterParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterParameterGroup), err
...
func (c *FakeDocdbClusterParameterGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(docdbclusterparametergroupsResource, name), &v1alpha1.DocdbClusterParameterGroup{})
	return err
}
...
func (c *FakeDocdbClusterParameterGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(docdbclusterparametergroupsResource, listOptions)
...
func (c *FakeDocdbClusterParameterGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DocdbClusterParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(docdbclusterparametergroupsResource, name, pt, data, subresources...), &v1alpha1.DocdbClusterParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DocdbClusterParameterGroup), err
