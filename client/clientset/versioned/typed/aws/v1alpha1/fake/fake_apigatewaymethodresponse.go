...
func (c *FakeApiGatewayMethodResponses) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayMethodResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(apigatewaymethodresponsesResource, name), &v1alpha1.ApiGatewayMethodResponse{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiGatewayMethodResponses) List(opts v1.ListOptions) (result *v1alpha1.ApiGatewayMethodResponseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(apigatewaymethodresponsesResource, apigatewaymethodresponsesKind, opts), &v1alpha1.ApiGatewayMethodResponseList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiGatewayMethodResponses) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(apigatewaymethodresponsesResource, opts))
}
...
func (c *FakeApiGatewayMethodResponses) Create(apiGatewayMethodResponse *v1alpha1.ApiGatewayMethodResponse) (result *v1alpha1.ApiGatewayMethodResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(apigatewaymethodresponsesResource, apiGatewayMethodResponse), &v1alpha1.ApiGatewayMethodResponse{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayMethodResponse), err
...
func (c *FakeApiGatewayMethodResponses) Update(apiGatewayMethodResponse *v1alpha1.ApiGatewayMethodResponse) (result *v1alpha1.ApiGatewayMethodResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(apigatewaymethodresponsesResource, apiGatewayMethodResponse), &v1alpha1.ApiGatewayMethodResponse{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayMethodResponse), err
...
func (c *FakeApiGatewayMethodResponses) UpdateStatus(apiGatewayMethodResponse *v1alpha1.ApiGatewayMethodResponse) (*v1alpha1.ApiGatewayMethodResponse, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(apigatewaymethodresponsesResource, "status", apiGatewayMethodResponse), &v1alpha1.ApiGatewayMethodResponse{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayMethodResponse), err
...
func (c *FakeApiGatewayMethodResponses) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(apigatewaymethodresponsesResource, name), &v1alpha1.ApiGatewayMethodResponse{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeApiGatewayMethodResponses) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(apigatewaymethodresponsesResource, listOptions)
...
func (c *FakeApiGatewayMethodResponses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiGatewayMethodResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apigatewaymethodresponsesResource, name, pt, data, subresources...), &v1alpha1.ApiGatewayMethodResponse{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiGatewayMethodResponse), err
