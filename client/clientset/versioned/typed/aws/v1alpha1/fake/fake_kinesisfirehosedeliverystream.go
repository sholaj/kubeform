...
func (c *FakeKinesisFirehoseDeliveryStreams) Get(name string, options v1.GetOptions) (result *v1alpha1.KinesisFirehoseDeliveryStream, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(kinesisfirehosedeliverystreamsResource, name), &v1alpha1.KinesisFirehoseDeliveryStream{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeKinesisFirehoseDeliveryStreams) List(opts v1.ListOptions) (result *v1alpha1.KinesisFirehoseDeliveryStreamList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(kinesisfirehosedeliverystreamsResource, kinesisfirehosedeliverystreamsKind, opts), &v1alpha1.KinesisFirehoseDeliveryStreamList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeKinesisFirehoseDeliveryStreams) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(kinesisfirehosedeliverystreamsResource, opts))
}
...
func (c *FakeKinesisFirehoseDeliveryStreams) Create(kinesisFirehoseDeliveryStream *v1alpha1.KinesisFirehoseDeliveryStream) (result *v1alpha1.KinesisFirehoseDeliveryStream, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(kinesisfirehosedeliverystreamsResource, kinesisFirehoseDeliveryStream), &v1alpha1.KinesisFirehoseDeliveryStream{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.KinesisFirehoseDeliveryStream), err
...
func (c *FakeKinesisFirehoseDeliveryStreams) Update(kinesisFirehoseDeliveryStream *v1alpha1.KinesisFirehoseDeliveryStream) (result *v1alpha1.KinesisFirehoseDeliveryStream, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(kinesisfirehosedeliverystreamsResource, kinesisFirehoseDeliveryStream), &v1alpha1.KinesisFirehoseDeliveryStream{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.KinesisFirehoseDeliveryStream), err
...
func (c *FakeKinesisFirehoseDeliveryStreams) UpdateStatus(kinesisFirehoseDeliveryStream *v1alpha1.KinesisFirehoseDeliveryStream) (*v1alpha1.KinesisFirehoseDeliveryStream, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(kinesisfirehosedeliverystreamsResource, "status", kinesisFirehoseDeliveryStream), &v1alpha1.KinesisFirehoseDeliveryStream{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.KinesisFirehoseDeliveryStream), err
...
func (c *FakeKinesisFirehoseDeliveryStreams) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(kinesisfirehosedeliverystreamsResource, name), &v1alpha1.KinesisFirehoseDeliveryStream{})
	return err
}
...
func (c *FakeKinesisFirehoseDeliveryStreams) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(kinesisfirehosedeliverystreamsResource, listOptions)
...
func (c *FakeKinesisFirehoseDeliveryStreams) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.KinesisFirehoseDeliveryStream, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(kinesisfirehosedeliverystreamsResource, name, pt, data, subresources...), &v1alpha1.KinesisFirehoseDeliveryStream{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.KinesisFirehoseDeliveryStream), err
