...
func (c *FakeRoute53ResolverRuleAssociations) Get(name string, options v1.GetOptions) (result *v1alpha1.Route53ResolverRuleAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(route53resolverruleassociationsResource, name), &v1alpha1.Route53ResolverRuleAssociation{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeRoute53ResolverRuleAssociations) List(opts v1.ListOptions) (result *v1alpha1.Route53ResolverRuleAssociationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(route53resolverruleassociationsResource, route53resolverruleassociationsKind, opts), &v1alpha1.Route53ResolverRuleAssociationList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeRoute53ResolverRuleAssociations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(route53resolverruleassociationsResource, opts))
}
...
func (c *FakeRoute53ResolverRuleAssociations) Create(route53ResolverRuleAssociation *v1alpha1.Route53ResolverRuleAssociation) (result *v1alpha1.Route53ResolverRuleAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(route53resolverruleassociationsResource, route53ResolverRuleAssociation), &v1alpha1.Route53ResolverRuleAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Route53ResolverRuleAssociation), err
...
func (c *FakeRoute53ResolverRuleAssociations) Update(route53ResolverRuleAssociation *v1alpha1.Route53ResolverRuleAssociation) (result *v1alpha1.Route53ResolverRuleAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(route53resolverruleassociationsResource, route53ResolverRuleAssociation), &v1alpha1.Route53ResolverRuleAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Route53ResolverRuleAssociation), err
...
func (c *FakeRoute53ResolverRuleAssociations) UpdateStatus(route53ResolverRuleAssociation *v1alpha1.Route53ResolverRuleAssociation) (*v1alpha1.Route53ResolverRuleAssociation, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(route53resolverruleassociationsResource, "status", route53ResolverRuleAssociation), &v1alpha1.Route53ResolverRuleAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Route53ResolverRuleAssociation), err
...
func (c *FakeRoute53ResolverRuleAssociations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(route53resolverruleassociationsResource, name), &v1alpha1.Route53ResolverRuleAssociation{})
	return err
}
...
func (c *FakeRoute53ResolverRuleAssociations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(route53resolverruleassociationsResource, listOptions)
...
func (c *FakeRoute53ResolverRuleAssociations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Route53ResolverRuleAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(route53resolverruleassociationsResource, name, pt, data, subresources...), &v1alpha1.Route53ResolverRuleAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Route53ResolverRuleAssociation), err
