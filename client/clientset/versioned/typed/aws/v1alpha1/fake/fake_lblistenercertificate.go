...
func (c *FakeLbListenerCertificates) Get(name string, options v1.GetOptions) (result *v1alpha1.LbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(lblistenercertificatesResource, name), &v1alpha1.LbListenerCertificate{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLbListenerCertificates) List(opts v1.ListOptions) (result *v1alpha1.LbListenerCertificateList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(lblistenercertificatesResource, lblistenercertificatesKind, opts), &v1alpha1.LbListenerCertificateList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLbListenerCertificates) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(lblistenercertificatesResource, opts))
}
...
func (c *FakeLbListenerCertificates) Create(lbListenerCertificate *v1alpha1.LbListenerCertificate) (result *v1alpha1.LbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(lblistenercertificatesResource, lbListenerCertificate), &v1alpha1.LbListenerCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LbListenerCertificate), err
...
func (c *FakeLbListenerCertificates) Update(lbListenerCertificate *v1alpha1.LbListenerCertificate) (result *v1alpha1.LbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(lblistenercertificatesResource, lbListenerCertificate), &v1alpha1.LbListenerCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LbListenerCertificate), err
...
func (c *FakeLbListenerCertificates) UpdateStatus(lbListenerCertificate *v1alpha1.LbListenerCertificate) (*v1alpha1.LbListenerCertificate, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(lblistenercertificatesResource, "status", lbListenerCertificate), &v1alpha1.LbListenerCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LbListenerCertificate), err
...
func (c *FakeLbListenerCertificates) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(lblistenercertificatesResource, name), &v1alpha1.LbListenerCertificate{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeLbListenerCertificates) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(lblistenercertificatesResource, listOptions)
...
func (c *FakeLbListenerCertificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(lblistenercertificatesResource, name, pt, data, subresources...), &v1alpha1.LbListenerCertificate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LbListenerCertificate), err
