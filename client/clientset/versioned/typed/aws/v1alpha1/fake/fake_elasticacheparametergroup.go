...
func (c *FakeElasticacheParameterGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.ElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(elasticacheparametergroupsResource, name), &v1alpha1.ElasticacheParameterGroup{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeElasticacheParameterGroups) List(opts v1.ListOptions) (result *v1alpha1.ElasticacheParameterGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(elasticacheparametergroupsResource, elasticacheparametergroupsKind, opts), &v1alpha1.ElasticacheParameterGroupList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeElasticacheParameterGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(elasticacheparametergroupsResource, opts))
}
...
func (c *FakeElasticacheParameterGroups) Create(elasticacheParameterGroup *v1alpha1.ElasticacheParameterGroup) (result *v1alpha1.ElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(elasticacheparametergroupsResource, elasticacheParameterGroup), &v1alpha1.ElasticacheParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticacheParameterGroup), err
...
func (c *FakeElasticacheParameterGroups) Update(elasticacheParameterGroup *v1alpha1.ElasticacheParameterGroup) (result *v1alpha1.ElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(elasticacheparametergroupsResource, elasticacheParameterGroup), &v1alpha1.ElasticacheParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticacheParameterGroup), err
...
func (c *FakeElasticacheParameterGroups) UpdateStatus(elasticacheParameterGroup *v1alpha1.ElasticacheParameterGroup) (*v1alpha1.ElasticacheParameterGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(elasticacheparametergroupsResource, "status", elasticacheParameterGroup), &v1alpha1.ElasticacheParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticacheParameterGroup), err
...
func (c *FakeElasticacheParameterGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(elasticacheparametergroupsResource, name), &v1alpha1.ElasticacheParameterGroup{})
	return err
}
...
func (c *FakeElasticacheParameterGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(elasticacheparametergroupsResource, listOptions)
...
func (c *FakeElasticacheParameterGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(elasticacheparametergroupsResource, name, pt, data, subresources...), &v1alpha1.ElasticacheParameterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticacheParameterGroup), err
