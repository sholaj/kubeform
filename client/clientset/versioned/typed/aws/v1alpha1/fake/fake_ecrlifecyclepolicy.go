...
func (c *FakeEcrLifecyclePolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.EcrLifecyclePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(ecrlifecyclepoliciesResource, name), &v1alpha1.EcrLifecyclePolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeEcrLifecyclePolicies) List(opts v1.ListOptions) (result *v1alpha1.EcrLifecyclePolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(ecrlifecyclepoliciesResource, ecrlifecyclepoliciesKind, opts), &v1alpha1.EcrLifecyclePolicyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeEcrLifecyclePolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(ecrlifecyclepoliciesResource, opts))
}
...
func (c *FakeEcrLifecyclePolicies) Create(ecrLifecyclePolicy *v1alpha1.EcrLifecyclePolicy) (result *v1alpha1.EcrLifecyclePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(ecrlifecyclepoliciesResource, ecrLifecyclePolicy), &v1alpha1.EcrLifecyclePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EcrLifecyclePolicy), err
...
func (c *FakeEcrLifecyclePolicies) Update(ecrLifecyclePolicy *v1alpha1.EcrLifecyclePolicy) (result *v1alpha1.EcrLifecyclePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(ecrlifecyclepoliciesResource, ecrLifecyclePolicy), &v1alpha1.EcrLifecyclePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EcrLifecyclePolicy), err
...
func (c *FakeEcrLifecyclePolicies) UpdateStatus(ecrLifecyclePolicy *v1alpha1.EcrLifecyclePolicy) (*v1alpha1.EcrLifecyclePolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(ecrlifecyclepoliciesResource, "status", ecrLifecyclePolicy), &v1alpha1.EcrLifecyclePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EcrLifecyclePolicy), err
...
func (c *FakeEcrLifecyclePolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(ecrlifecyclepoliciesResource, name), &v1alpha1.EcrLifecyclePolicy{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeEcrLifecyclePolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(ecrlifecyclepoliciesResource, listOptions)
...
func (c *FakeEcrLifecyclePolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.EcrLifecyclePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(ecrlifecyclepoliciesResource, name, pt, data, subresources...), &v1alpha1.EcrLifecyclePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EcrLifecyclePolicy), err
