...
func (c *FakeDmsReplicationInstances) Get(name string, options v1.GetOptions) (result *v1alpha1.DmsReplicationInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(dmsreplicationinstancesResource, name), &v1alpha1.DmsReplicationInstance{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDmsReplicationInstances) List(opts v1.ListOptions) (result *v1alpha1.DmsReplicationInstanceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(dmsreplicationinstancesResource, dmsreplicationinstancesKind, opts), &v1alpha1.DmsReplicationInstanceList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDmsReplicationInstances) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(dmsreplicationinstancesResource, opts))
}
...
func (c *FakeDmsReplicationInstances) Create(dmsReplicationInstance *v1alpha1.DmsReplicationInstance) (result *v1alpha1.DmsReplicationInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(dmsreplicationinstancesResource, dmsReplicationInstance), &v1alpha1.DmsReplicationInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DmsReplicationInstance), err
...
func (c *FakeDmsReplicationInstances) Update(dmsReplicationInstance *v1alpha1.DmsReplicationInstance) (result *v1alpha1.DmsReplicationInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(dmsreplicationinstancesResource, dmsReplicationInstance), &v1alpha1.DmsReplicationInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DmsReplicationInstance), err
...
func (c *FakeDmsReplicationInstances) UpdateStatus(dmsReplicationInstance *v1alpha1.DmsReplicationInstance) (*v1alpha1.DmsReplicationInstance, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(dmsreplicationinstancesResource, "status", dmsReplicationInstance), &v1alpha1.DmsReplicationInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DmsReplicationInstance), err
...
func (c *FakeDmsReplicationInstances) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(dmsreplicationinstancesResource, name), &v1alpha1.DmsReplicationInstance{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeDmsReplicationInstances) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(dmsreplicationinstancesResource, listOptions)
...
func (c *FakeDmsReplicationInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DmsReplicationInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(dmsreplicationinstancesResource, name, pt, data, subresources...), &v1alpha1.DmsReplicationInstance{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DmsReplicationInstance), err
