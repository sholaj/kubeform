...
func (c *FakeIamInstanceProfiles) Get(name string, options v1.GetOptions) (result *v1alpha1.IamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(iaminstanceprofilesResource, name), &v1alpha1.IamInstanceProfile{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeIamInstanceProfiles) List(opts v1.ListOptions) (result *v1alpha1.IamInstanceProfileList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(iaminstanceprofilesResource, iaminstanceprofilesKind, opts), &v1alpha1.IamInstanceProfileList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeIamInstanceProfiles) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(iaminstanceprofilesResource, opts))
}
...
func (c *FakeIamInstanceProfiles) Create(iamInstanceProfile *v1alpha1.IamInstanceProfile) (result *v1alpha1.IamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(iaminstanceprofilesResource, iamInstanceProfile), &v1alpha1.IamInstanceProfile{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamInstanceProfile), err
...
func (c *FakeIamInstanceProfiles) Update(iamInstanceProfile *v1alpha1.IamInstanceProfile) (result *v1alpha1.IamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(iaminstanceprofilesResource, iamInstanceProfile), &v1alpha1.IamInstanceProfile{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamInstanceProfile), err
...
func (c *FakeIamInstanceProfiles) UpdateStatus(iamInstanceProfile *v1alpha1.IamInstanceProfile) (*v1alpha1.IamInstanceProfile, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(iaminstanceprofilesResource, "status", iamInstanceProfile), &v1alpha1.IamInstanceProfile{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamInstanceProfile), err
...
func (c *FakeIamInstanceProfiles) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(iaminstanceprofilesResource, name), &v1alpha1.IamInstanceProfile{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeIamInstanceProfiles) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(iaminstanceprofilesResource, listOptions)
...
func (c *FakeIamInstanceProfiles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(iaminstanceprofilesResource, name, pt, data, subresources...), &v1alpha1.IamInstanceProfile{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamInstanceProfile), err
