...
func (c *FakeVpcPeeringConnectionAccepters) Get(name string, options v1.GetOptions) (result *v1alpha1.VpcPeeringConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(vpcpeeringconnectionacceptersResource, name), &v1alpha1.VpcPeeringConnectionAccepter{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVpcPeeringConnectionAccepters) List(opts v1.ListOptions) (result *v1alpha1.VpcPeeringConnectionAccepterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(vpcpeeringconnectionacceptersResource, vpcpeeringconnectionacceptersKind, opts), &v1alpha1.VpcPeeringConnectionAccepterList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVpcPeeringConnectionAccepters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(vpcpeeringconnectionacceptersResource, opts))
}
...
func (c *FakeVpcPeeringConnectionAccepters) Create(vpcPeeringConnectionAccepter *v1alpha1.VpcPeeringConnectionAccepter) (result *v1alpha1.VpcPeeringConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(vpcpeeringconnectionacceptersResource, vpcPeeringConnectionAccepter), &v1alpha1.VpcPeeringConnectionAccepter{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VpcPeeringConnectionAccepter), err
...
func (c *FakeVpcPeeringConnectionAccepters) Update(vpcPeeringConnectionAccepter *v1alpha1.VpcPeeringConnectionAccepter) (result *v1alpha1.VpcPeeringConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(vpcpeeringconnectionacceptersResource, vpcPeeringConnectionAccepter), &v1alpha1.VpcPeeringConnectionAccepter{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VpcPeeringConnectionAccepter), err
...
func (c *FakeVpcPeeringConnectionAccepters) UpdateStatus(vpcPeeringConnectionAccepter *v1alpha1.VpcPeeringConnectionAccepter) (*v1alpha1.VpcPeeringConnectionAccepter, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(vpcpeeringconnectionacceptersResource, "status", vpcPeeringConnectionAccepter), &v1alpha1.VpcPeeringConnectionAccepter{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VpcPeeringConnectionAccepter), err
...
func (c *FakeVpcPeeringConnectionAccepters) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(vpcpeeringconnectionacceptersResource, name), &v1alpha1.VpcPeeringConnectionAccepter{})
	return err
}
...
func (c *FakeVpcPeeringConnectionAccepters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(vpcpeeringconnectionacceptersResource, listOptions)
...
func (c *FakeVpcPeeringConnectionAccepters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VpcPeeringConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(vpcpeeringconnectionacceptersResource, name, pt, data, subresources...), &v1alpha1.VpcPeeringConnectionAccepter{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VpcPeeringConnectionAccepter), err
