...
func (c *FakeAutoscalingNotifications) Get(name string, options v1.GetOptions) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(autoscalingnotificationsResource, name), &v1alpha1.AutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAutoscalingNotifications) List(opts v1.ListOptions) (result *v1alpha1.AutoscalingNotificationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(autoscalingnotificationsResource, autoscalingnotificationsKind, opts), &v1alpha1.AutoscalingNotificationList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAutoscalingNotifications) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(autoscalingnotificationsResource, opts))
}
...
func (c *FakeAutoscalingNotifications) Create(autoscalingNotification *v1alpha1.AutoscalingNotification) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(autoscalingnotificationsResource, autoscalingNotification), &v1alpha1.AutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AutoscalingNotification), err
...
func (c *FakeAutoscalingNotifications) Update(autoscalingNotification *v1alpha1.AutoscalingNotification) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(autoscalingnotificationsResource, autoscalingNotification), &v1alpha1.AutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AutoscalingNotification), err
...
func (c *FakeAutoscalingNotifications) UpdateStatus(autoscalingNotification *v1alpha1.AutoscalingNotification) (*v1alpha1.AutoscalingNotification, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(autoscalingnotificationsResource, "status", autoscalingNotification), &v1alpha1.AutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AutoscalingNotification), err
...
func (c *FakeAutoscalingNotifications) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(autoscalingnotificationsResource, name), &v1alpha1.AutoscalingNotification{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAutoscalingNotifications) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(autoscalingnotificationsResource, listOptions)
...
func (c *FakeAutoscalingNotifications) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(autoscalingnotificationsResource, name, pt, data, subresources...), &v1alpha1.AutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AutoscalingNotification), err
