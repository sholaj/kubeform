...
func (c *FakeElasticBeanstalkEnvironments) Get(name string, options v1.GetOptions) (result *v1alpha1.ElasticBeanstalkEnvironment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(elasticbeanstalkenvironmentsResource, name), &v1alpha1.ElasticBeanstalkEnvironment{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeElasticBeanstalkEnvironments) List(opts v1.ListOptions) (result *v1alpha1.ElasticBeanstalkEnvironmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(elasticbeanstalkenvironmentsResource, elasticbeanstalkenvironmentsKind, opts), &v1alpha1.ElasticBeanstalkEnvironmentList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeElasticBeanstalkEnvironments) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(elasticbeanstalkenvironmentsResource, opts))
}
...
func (c *FakeElasticBeanstalkEnvironments) Create(elasticBeanstalkEnvironment *v1alpha1.ElasticBeanstalkEnvironment) (result *v1alpha1.ElasticBeanstalkEnvironment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(elasticbeanstalkenvironmentsResource, elasticBeanstalkEnvironment), &v1alpha1.ElasticBeanstalkEnvironment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticBeanstalkEnvironment), err
...
func (c *FakeElasticBeanstalkEnvironments) Update(elasticBeanstalkEnvironment *v1alpha1.ElasticBeanstalkEnvironment) (result *v1alpha1.ElasticBeanstalkEnvironment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(elasticbeanstalkenvironmentsResource, elasticBeanstalkEnvironment), &v1alpha1.ElasticBeanstalkEnvironment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticBeanstalkEnvironment), err
...
func (c *FakeElasticBeanstalkEnvironments) UpdateStatus(elasticBeanstalkEnvironment *v1alpha1.ElasticBeanstalkEnvironment) (*v1alpha1.ElasticBeanstalkEnvironment, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(elasticbeanstalkenvironmentsResource, "status", elasticBeanstalkEnvironment), &v1alpha1.ElasticBeanstalkEnvironment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticBeanstalkEnvironment), err
...
func (c *FakeElasticBeanstalkEnvironments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(elasticbeanstalkenvironmentsResource, name), &v1alpha1.ElasticBeanstalkEnvironment{})
	return err
}
...
func (c *FakeElasticBeanstalkEnvironments) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(elasticbeanstalkenvironmentsResource, listOptions)
...
func (c *FakeElasticBeanstalkEnvironments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ElasticBeanstalkEnvironment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(elasticbeanstalkenvironmentsResource, name, pt, data, subresources...), &v1alpha1.ElasticBeanstalkEnvironment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticBeanstalkEnvironment), err
