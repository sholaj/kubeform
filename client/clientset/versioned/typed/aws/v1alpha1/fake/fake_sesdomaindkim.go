...
func (c *FakeSesDomainDkims) Get(name string, options v1.GetOptions) (result *v1alpha1.SesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(sesdomaindkimsResource, name), &v1alpha1.SesDomainDkim{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSesDomainDkims) List(opts v1.ListOptions) (result *v1alpha1.SesDomainDkimList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(sesdomaindkimsResource, sesdomaindkimsKind, opts), &v1alpha1.SesDomainDkimList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSesDomainDkims) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(sesdomaindkimsResource, opts))
}
...
func (c *FakeSesDomainDkims) Create(sesDomainDkim *v1alpha1.SesDomainDkim) (result *v1alpha1.SesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(sesdomaindkimsResource, sesDomainDkim), &v1alpha1.SesDomainDkim{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesDomainDkim), err
...
func (c *FakeSesDomainDkims) Update(sesDomainDkim *v1alpha1.SesDomainDkim) (result *v1alpha1.SesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(sesdomaindkimsResource, sesDomainDkim), &v1alpha1.SesDomainDkim{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesDomainDkim), err
...
func (c *FakeSesDomainDkims) UpdateStatus(sesDomainDkim *v1alpha1.SesDomainDkim) (*v1alpha1.SesDomainDkim, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(sesdomaindkimsResource, "status", sesDomainDkim), &v1alpha1.SesDomainDkim{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesDomainDkim), err
...
func (c *FakeSesDomainDkims) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(sesdomaindkimsResource, name), &v1alpha1.SesDomainDkim{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeSesDomainDkims) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(sesdomaindkimsResource, listOptions)
...
func (c *FakeSesDomainDkims) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(sesdomaindkimsResource, name, pt, data, subresources...), &v1alpha1.SesDomainDkim{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SesDomainDkim), err
