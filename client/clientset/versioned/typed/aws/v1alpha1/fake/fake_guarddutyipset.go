...
func (c *FakeGuarddutyIpsets) Get(name string, options v1.GetOptions) (result *v1alpha1.GuarddutyIpset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(guarddutyipsetsResource, name), &v1alpha1.GuarddutyIpset{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeGuarddutyIpsets) List(opts v1.ListOptions) (result *v1alpha1.GuarddutyIpsetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(guarddutyipsetsResource, guarddutyipsetsKind, opts), &v1alpha1.GuarddutyIpsetList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeGuarddutyIpsets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(guarddutyipsetsResource, opts))
}
...
func (c *FakeGuarddutyIpsets) Create(guarddutyIpset *v1alpha1.GuarddutyIpset) (result *v1alpha1.GuarddutyIpset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(guarddutyipsetsResource, guarddutyIpset), &v1alpha1.GuarddutyIpset{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GuarddutyIpset), err
...
func (c *FakeGuarddutyIpsets) Update(guarddutyIpset *v1alpha1.GuarddutyIpset) (result *v1alpha1.GuarddutyIpset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(guarddutyipsetsResource, guarddutyIpset), &v1alpha1.GuarddutyIpset{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GuarddutyIpset), err
...
func (c *FakeGuarddutyIpsets) UpdateStatus(guarddutyIpset *v1alpha1.GuarddutyIpset) (*v1alpha1.GuarddutyIpset, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(guarddutyipsetsResource, "status", guarddutyIpset), &v1alpha1.GuarddutyIpset{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GuarddutyIpset), err
...
func (c *FakeGuarddutyIpsets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(guarddutyipsetsResource, name), &v1alpha1.GuarddutyIpset{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeGuarddutyIpsets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(guarddutyipsetsResource, listOptions)
...
func (c *FakeGuarddutyIpsets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.GuarddutyIpset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(guarddutyipsetsResource, name, pt, data, subresources...), &v1alpha1.GuarddutyIpset{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GuarddutyIpset), err
