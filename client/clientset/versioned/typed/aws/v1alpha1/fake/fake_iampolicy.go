...
func (c *FakeIamPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.IamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(iampoliciesResource, name), &v1alpha1.IamPolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeIamPolicies) List(opts v1.ListOptions) (result *v1alpha1.IamPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(iampoliciesResource, iampoliciesKind, opts), &v1alpha1.IamPolicyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeIamPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(iampoliciesResource, opts))
}
...
func (c *FakeIamPolicies) Create(iamPolicy *v1alpha1.IamPolicy) (result *v1alpha1.IamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(iampoliciesResource, iamPolicy), &v1alpha1.IamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamPolicy), err
...
func (c *FakeIamPolicies) Update(iamPolicy *v1alpha1.IamPolicy) (result *v1alpha1.IamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(iampoliciesResource, iamPolicy), &v1alpha1.IamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamPolicy), err
...
func (c *FakeIamPolicies) UpdateStatus(iamPolicy *v1alpha1.IamPolicy) (*v1alpha1.IamPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(iampoliciesResource, "status", iamPolicy), &v1alpha1.IamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamPolicy), err
...
func (c *FakeIamPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(iampoliciesResource, name), &v1alpha1.IamPolicy{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeIamPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(iampoliciesResource, listOptions)
...
func (c *FakeIamPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(iampoliciesResource, name, pt, data, subresources...), &v1alpha1.IamPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamPolicy), err
