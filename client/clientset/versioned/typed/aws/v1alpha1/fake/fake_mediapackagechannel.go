...
func (c *FakeMediaPackageChannels) Get(name string, options v1.GetOptions) (result *v1alpha1.MediaPackageChannel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(mediapackagechannelsResource, name), &v1alpha1.MediaPackageChannel{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMediaPackageChannels) List(opts v1.ListOptions) (result *v1alpha1.MediaPackageChannelList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(mediapackagechannelsResource, mediapackagechannelsKind, opts), &v1alpha1.MediaPackageChannelList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMediaPackageChannels) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(mediapackagechannelsResource, opts))
}
...
func (c *FakeMediaPackageChannels) Create(mediaPackageChannel *v1alpha1.MediaPackageChannel) (result *v1alpha1.MediaPackageChannel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(mediapackagechannelsResource, mediaPackageChannel), &v1alpha1.MediaPackageChannel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MediaPackageChannel), err
...
func (c *FakeMediaPackageChannels) Update(mediaPackageChannel *v1alpha1.MediaPackageChannel) (result *v1alpha1.MediaPackageChannel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(mediapackagechannelsResource, mediaPackageChannel), &v1alpha1.MediaPackageChannel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MediaPackageChannel), err
...
func (c *FakeMediaPackageChannels) UpdateStatus(mediaPackageChannel *v1alpha1.MediaPackageChannel) (*v1alpha1.MediaPackageChannel, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(mediapackagechannelsResource, "status", mediaPackageChannel), &v1alpha1.MediaPackageChannel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MediaPackageChannel), err
...
func (c *FakeMediaPackageChannels) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(mediapackagechannelsResource, name), &v1alpha1.MediaPackageChannel{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeMediaPackageChannels) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(mediapackagechannelsResource, listOptions)
...
func (c *FakeMediaPackageChannels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MediaPackageChannel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(mediapackagechannelsResource, name, pt, data, subresources...), &v1alpha1.MediaPackageChannel{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MediaPackageChannel), err
