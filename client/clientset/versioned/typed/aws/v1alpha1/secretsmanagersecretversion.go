...
type SecretsmanagerSecretVersionsGetter interface {
	SecretsmanagerSecretVersions() SecretsmanagerSecretVersionInterface
}
...
func newSecretsmanagerSecretVersions(c *AwsV1alpha1Client) *secretsmanagerSecretVersions {
