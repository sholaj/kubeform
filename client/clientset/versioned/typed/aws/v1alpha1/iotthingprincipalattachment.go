...
type IotThingPrincipalAttachmentsGetter interface {
	IotThingPrincipalAttachments() IotThingPrincipalAttachmentInterface
}
...
func newIotThingPrincipalAttachments(c *AwsV1alpha1Client) *iotThingPrincipalAttachments {
