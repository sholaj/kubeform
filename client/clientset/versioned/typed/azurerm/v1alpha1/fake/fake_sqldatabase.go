...
func (c *FakeSqlDatabases) Get(name string, options v1.GetOptions) (result *v1alpha1.SqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(sqldatabasesResource, name), &v1alpha1.SqlDatabase{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSqlDatabases) List(opts v1.ListOptions) (result *v1alpha1.SqlDatabaseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(sqldatabasesResource, sqldatabasesKind, opts), &v1alpha1.SqlDatabaseList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSqlDatabases) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(sqldatabasesResource, opts))
}
...
func (c *FakeSqlDatabases) Create(sqlDatabase *v1alpha1.SqlDatabase) (result *v1alpha1.SqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(sqldatabasesResource, sqlDatabase), &v1alpha1.SqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SqlDatabase), err
...
func (c *FakeSqlDatabases) Update(sqlDatabase *v1alpha1.SqlDatabase) (result *v1alpha1.SqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(sqldatabasesResource, sqlDatabase), &v1alpha1.SqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SqlDatabase), err
...
func (c *FakeSqlDatabases) UpdateStatus(sqlDatabase *v1alpha1.SqlDatabase) (*v1alpha1.SqlDatabase, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(sqldatabasesResource, "status", sqlDatabase), &v1alpha1.SqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SqlDatabase), err
...
func (c *FakeSqlDatabases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(sqldatabasesResource, name), &v1alpha1.SqlDatabase{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeSqlDatabases) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(sqldatabasesResource, listOptions)
...
func (c *FakeSqlDatabases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(sqldatabasesResource, name, pt, data, subresources...), &v1alpha1.SqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SqlDatabase), err
