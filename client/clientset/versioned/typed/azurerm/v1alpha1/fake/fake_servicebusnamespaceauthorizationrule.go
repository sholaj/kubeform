...
func (c *FakeServicebusNamespaceAuthorizationRules) Get(name string, options v1.GetOptions) (result *v1alpha1.ServicebusNamespaceAuthorizationRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(servicebusnamespaceauthorizationrulesResource, name), &v1alpha1.ServicebusNamespaceAuthorizationRule{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeServicebusNamespaceAuthorizationRules) List(opts v1.ListOptions) (result *v1alpha1.ServicebusNamespaceAuthorizationRuleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(servicebusnamespaceauthorizationrulesResource, servicebusnamespaceauthorizationrulesKind, opts), &v1alpha1.ServicebusNamespaceAuthorizationRuleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeServicebusNamespaceAuthorizationRules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(servicebusnamespaceauthorizationrulesResource, opts))
}
...
func (c *FakeServicebusNamespaceAuthorizationRules) Create(servicebusNamespaceAuthorizationRule *v1alpha1.ServicebusNamespaceAuthorizationRule) (result *v1alpha1.ServicebusNamespaceAuthorizationRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(servicebusnamespaceauthorizationrulesResource, servicebusNamespaceAuthorizationRule), &v1alpha1.ServicebusNamespaceAuthorizationRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServicebusNamespaceAuthorizationRule), err
...
func (c *FakeServicebusNamespaceAuthorizationRules) Update(servicebusNamespaceAuthorizationRule *v1alpha1.ServicebusNamespaceAuthorizationRule) (result *v1alpha1.ServicebusNamespaceAuthorizationRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(servicebusnamespaceauthorizationrulesResource, servicebusNamespaceAuthorizationRule), &v1alpha1.ServicebusNamespaceAuthorizationRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServicebusNamespaceAuthorizationRule), err
...
func (c *FakeServicebusNamespaceAuthorizationRules) UpdateStatus(servicebusNamespaceAuthorizationRule *v1alpha1.ServicebusNamespaceAuthorizationRule) (*v1alpha1.ServicebusNamespaceAuthorizationRule, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(servicebusnamespaceauthorizationrulesResource, "status", servicebusNamespaceAuthorizationRule), &v1alpha1.ServicebusNamespaceAuthorizationRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServicebusNamespaceAuthorizationRule), err
...
func (c *FakeServicebusNamespaceAuthorizationRules) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(servicebusnamespaceauthorizationrulesResource, name), &v1alpha1.ServicebusNamespaceAuthorizationRule{})
	return err
}
...
func (c *FakeServicebusNamespaceAuthorizationRules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(servicebusnamespaceauthorizationrulesResource, listOptions)
...
func (c *FakeServicebusNamespaceAuthorizationRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServicebusNamespaceAuthorizationRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(servicebusnamespaceauthorizationrulesResource, name, pt, data, subresources...), &v1alpha1.ServicebusNamespaceAuthorizationRule{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServicebusNamespaceAuthorizationRule), err
