...
func (c *FakeDevspaceControllers) Get(name string, options v1.GetOptions) (result *v1alpha1.DevspaceController, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(devspacecontrollersResource, name), &v1alpha1.DevspaceController{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDevspaceControllers) List(opts v1.ListOptions) (result *v1alpha1.DevspaceControllerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(devspacecontrollersResource, devspacecontrollersKind, opts), &v1alpha1.DevspaceControllerList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeDevspaceControllers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(devspacecontrollersResource, opts))
}
...
func (c *FakeDevspaceControllers) Create(devspaceController *v1alpha1.DevspaceController) (result *v1alpha1.DevspaceController, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(devspacecontrollersResource, devspaceController), &v1alpha1.DevspaceController{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DevspaceController), err
...
func (c *FakeDevspaceControllers) Update(devspaceController *v1alpha1.DevspaceController) (result *v1alpha1.DevspaceController, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(devspacecontrollersResource, devspaceController), &v1alpha1.DevspaceController{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DevspaceController), err
...
func (c *FakeDevspaceControllers) UpdateStatus(devspaceController *v1alpha1.DevspaceController) (*v1alpha1.DevspaceController, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(devspacecontrollersResource, "status", devspaceController), &v1alpha1.DevspaceController{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DevspaceController), err
...
func (c *FakeDevspaceControllers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(devspacecontrollersResource, name), &v1alpha1.DevspaceController{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeDevspaceControllers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(devspacecontrollersResource, listOptions)
...
func (c *FakeDevspaceControllers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DevspaceController, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(devspacecontrollersResource, name, pt, data, subresources...), &v1alpha1.DevspaceController{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DevspaceController), err
