...
func (c *FakeApiManagementApiOperations) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiManagementApiOperation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(apimanagementapioperationsResource, name), &v1alpha1.ApiManagementApiOperation{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiManagementApiOperations) List(opts v1.ListOptions) (result *v1alpha1.ApiManagementApiOperationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(apimanagementapioperationsResource, apimanagementapioperationsKind, opts), &v1alpha1.ApiManagementApiOperationList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiManagementApiOperations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(apimanagementapioperationsResource, opts))
}
...
func (c *FakeApiManagementApiOperations) Create(apiManagementApiOperation *v1alpha1.ApiManagementApiOperation) (result *v1alpha1.ApiManagementApiOperation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(apimanagementapioperationsResource, apiManagementApiOperation), &v1alpha1.ApiManagementApiOperation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementApiOperation), err
...
func (c *FakeApiManagementApiOperations) Update(apiManagementApiOperation *v1alpha1.ApiManagementApiOperation) (result *v1alpha1.ApiManagementApiOperation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(apimanagementapioperationsResource, apiManagementApiOperation), &v1alpha1.ApiManagementApiOperation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementApiOperation), err
...
func (c *FakeApiManagementApiOperations) UpdateStatus(apiManagementApiOperation *v1alpha1.ApiManagementApiOperation) (*v1alpha1.ApiManagementApiOperation, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(apimanagementapioperationsResource, "status", apiManagementApiOperation), &v1alpha1.ApiManagementApiOperation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementApiOperation), err
...
func (c *FakeApiManagementApiOperations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(apimanagementapioperationsResource, name), &v1alpha1.ApiManagementApiOperation{})
	return err
}
...
func (c *FakeApiManagementApiOperations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(apimanagementapioperationsResource, listOptions)
...
func (c *FakeApiManagementApiOperations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiManagementApiOperation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apimanagementapioperationsResource, name, pt, data, subresources...), &v1alpha1.ApiManagementApiOperation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementApiOperation), err
