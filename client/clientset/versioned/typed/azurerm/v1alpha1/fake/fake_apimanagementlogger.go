...
func (c *FakeApiManagementLoggers) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiManagementLogger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(apimanagementloggersResource, name), &v1alpha1.ApiManagementLogger{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiManagementLoggers) List(opts v1.ListOptions) (result *v1alpha1.ApiManagementLoggerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(apimanagementloggersResource, apimanagementloggersKind, opts), &v1alpha1.ApiManagementLoggerList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiManagementLoggers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(apimanagementloggersResource, opts))
}
...
func (c *FakeApiManagementLoggers) Create(apiManagementLogger *v1alpha1.ApiManagementLogger) (result *v1alpha1.ApiManagementLogger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(apimanagementloggersResource, apiManagementLogger), &v1alpha1.ApiManagementLogger{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementLogger), err
...
func (c *FakeApiManagementLoggers) Update(apiManagementLogger *v1alpha1.ApiManagementLogger) (result *v1alpha1.ApiManagementLogger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(apimanagementloggersResource, apiManagementLogger), &v1alpha1.ApiManagementLogger{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementLogger), err
...
func (c *FakeApiManagementLoggers) UpdateStatus(apiManagementLogger *v1alpha1.ApiManagementLogger) (*v1alpha1.ApiManagementLogger, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(apimanagementloggersResource, "status", apiManagementLogger), &v1alpha1.ApiManagementLogger{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementLogger), err
...
func (c *FakeApiManagementLoggers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(apimanagementloggersResource, name), &v1alpha1.ApiManagementLogger{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeApiManagementLoggers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(apimanagementloggersResource, listOptions)
...
func (c *FakeApiManagementLoggers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiManagementLogger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apimanagementloggersResource, name, pt, data, subresources...), &v1alpha1.ApiManagementLogger{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementLogger), err
