...
func (c *FakeStorageTableEntities) Get(name string, options v1.GetOptions) (result *v1alpha1.StorageTableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(storagetableentitiesResource, name), &v1alpha1.StorageTableEntity{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStorageTableEntities) List(opts v1.ListOptions) (result *v1alpha1.StorageTableEntityList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(storagetableentitiesResource, storagetableentitiesKind, opts), &v1alpha1.StorageTableEntityList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStorageTableEntities) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(storagetableentitiesResource, opts))
}
...
func (c *FakeStorageTableEntities) Create(storageTableEntity *v1alpha1.StorageTableEntity) (result *v1alpha1.StorageTableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(storagetableentitiesResource, storageTableEntity), &v1alpha1.StorageTableEntity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageTableEntity), err
...
func (c *FakeStorageTableEntities) Update(storageTableEntity *v1alpha1.StorageTableEntity) (result *v1alpha1.StorageTableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(storagetableentitiesResource, storageTableEntity), &v1alpha1.StorageTableEntity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageTableEntity), err
...
func (c *FakeStorageTableEntities) UpdateStatus(storageTableEntity *v1alpha1.StorageTableEntity) (*v1alpha1.StorageTableEntity, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(storagetableentitiesResource, "status", storageTableEntity), &v1alpha1.StorageTableEntity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageTableEntity), err
...
func (c *FakeStorageTableEntities) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(storagetableentitiesResource, name), &v1alpha1.StorageTableEntity{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeStorageTableEntities) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(storagetableentitiesResource, listOptions)
...
func (c *FakeStorageTableEntities) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StorageTableEntity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(storagetableentitiesResource, name, pt, data, subresources...), &v1alpha1.StorageTableEntity{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StorageTableEntity), err
