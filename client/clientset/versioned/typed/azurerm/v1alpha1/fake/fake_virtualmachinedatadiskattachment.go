...
func (c *FakeVirtualMachineDataDiskAttachments) Get(name string, options v1.GetOptions) (result *v1alpha1.VirtualMachineDataDiskAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(virtualmachinedatadiskattachmentsResource, name), &v1alpha1.VirtualMachineDataDiskAttachment{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVirtualMachineDataDiskAttachments) List(opts v1.ListOptions) (result *v1alpha1.VirtualMachineDataDiskAttachmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(virtualmachinedatadiskattachmentsResource, virtualmachinedatadiskattachmentsKind, opts), &v1alpha1.VirtualMachineDataDiskAttachmentList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeVirtualMachineDataDiskAttachments) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(virtualmachinedatadiskattachmentsResource, opts))
}
...
func (c *FakeVirtualMachineDataDiskAttachments) Create(virtualMachineDataDiskAttachment *v1alpha1.VirtualMachineDataDiskAttachment) (result *v1alpha1.VirtualMachineDataDiskAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(virtualmachinedatadiskattachmentsResource, virtualMachineDataDiskAttachment), &v1alpha1.VirtualMachineDataDiskAttachment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VirtualMachineDataDiskAttachment), err
...
func (c *FakeVirtualMachineDataDiskAttachments) Update(virtualMachineDataDiskAttachment *v1alpha1.VirtualMachineDataDiskAttachment) (result *v1alpha1.VirtualMachineDataDiskAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(virtualmachinedatadiskattachmentsResource, virtualMachineDataDiskAttachment), &v1alpha1.VirtualMachineDataDiskAttachment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VirtualMachineDataDiskAttachment), err
...
func (c *FakeVirtualMachineDataDiskAttachments) UpdateStatus(virtualMachineDataDiskAttachment *v1alpha1.VirtualMachineDataDiskAttachment) (*v1alpha1.VirtualMachineDataDiskAttachment, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(virtualmachinedatadiskattachmentsResource, "status", virtualMachineDataDiskAttachment), &v1alpha1.VirtualMachineDataDiskAttachment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VirtualMachineDataDiskAttachment), err
...
func (c *FakeVirtualMachineDataDiskAttachments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(virtualmachinedatadiskattachmentsResource, name), &v1alpha1.VirtualMachineDataDiskAttachment{})
	return err
}
...
func (c *FakeVirtualMachineDataDiskAttachments) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(virtualmachinedatadiskattachmentsResource, listOptions)
...
func (c *FakeVirtualMachineDataDiskAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VirtualMachineDataDiskAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(virtualmachinedatadiskattachmentsResource, name, pt, data, subresources...), &v1alpha1.VirtualMachineDataDiskAttachment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VirtualMachineDataDiskAttachment), err
