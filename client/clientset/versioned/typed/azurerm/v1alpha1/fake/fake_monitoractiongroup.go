...
func (c *FakeMonitorActionGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.MonitorActionGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(monitoractiongroupsResource, name), &v1alpha1.MonitorActionGroup{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMonitorActionGroups) List(opts v1.ListOptions) (result *v1alpha1.MonitorActionGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(monitoractiongroupsResource, monitoractiongroupsKind, opts), &v1alpha1.MonitorActionGroupList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMonitorActionGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(monitoractiongroupsResource, opts))
}
...
func (c *FakeMonitorActionGroups) Create(monitorActionGroup *v1alpha1.MonitorActionGroup) (result *v1alpha1.MonitorActionGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(monitoractiongroupsResource, monitorActionGroup), &v1alpha1.MonitorActionGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MonitorActionGroup), err
...
func (c *FakeMonitorActionGroups) Update(monitorActionGroup *v1alpha1.MonitorActionGroup) (result *v1alpha1.MonitorActionGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(monitoractiongroupsResource, monitorActionGroup), &v1alpha1.MonitorActionGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MonitorActionGroup), err
...
func (c *FakeMonitorActionGroups) UpdateStatus(monitorActionGroup *v1alpha1.MonitorActionGroup) (*v1alpha1.MonitorActionGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(monitoractiongroupsResource, "status", monitorActionGroup), &v1alpha1.MonitorActionGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MonitorActionGroup), err
...
func (c *FakeMonitorActionGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(monitoractiongroupsResource, name), &v1alpha1.MonitorActionGroup{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeMonitorActionGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(monitoractiongroupsResource, listOptions)
...
func (c *FakeMonitorActionGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MonitorActionGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(monitoractiongroupsResource, name, pt, data, subresources...), &v1alpha1.MonitorActionGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MonitorActionGroup), err
