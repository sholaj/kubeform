...
func (c *FakeLogAnalyticsLinkedServices) Get(name string, options v1.GetOptions) (result *v1alpha1.LogAnalyticsLinkedService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(loganalyticslinkedservicesResource, name), &v1alpha1.LogAnalyticsLinkedService{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLogAnalyticsLinkedServices) List(opts v1.ListOptions) (result *v1alpha1.LogAnalyticsLinkedServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(loganalyticslinkedservicesResource, loganalyticslinkedservicesKind, opts), &v1alpha1.LogAnalyticsLinkedServiceList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLogAnalyticsLinkedServices) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(loganalyticslinkedservicesResource, opts))
}
...
func (c *FakeLogAnalyticsLinkedServices) Create(logAnalyticsLinkedService *v1alpha1.LogAnalyticsLinkedService) (result *v1alpha1.LogAnalyticsLinkedService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(loganalyticslinkedservicesResource, logAnalyticsLinkedService), &v1alpha1.LogAnalyticsLinkedService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LogAnalyticsLinkedService), err
...
func (c *FakeLogAnalyticsLinkedServices) Update(logAnalyticsLinkedService *v1alpha1.LogAnalyticsLinkedService) (result *v1alpha1.LogAnalyticsLinkedService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(loganalyticslinkedservicesResource, logAnalyticsLinkedService), &v1alpha1.LogAnalyticsLinkedService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LogAnalyticsLinkedService), err
...
func (c *FakeLogAnalyticsLinkedServices) UpdateStatus(logAnalyticsLinkedService *v1alpha1.LogAnalyticsLinkedService) (*v1alpha1.LogAnalyticsLinkedService, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(loganalyticslinkedservicesResource, "status", logAnalyticsLinkedService), &v1alpha1.LogAnalyticsLinkedService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LogAnalyticsLinkedService), err
...
func (c *FakeLogAnalyticsLinkedServices) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(loganalyticslinkedservicesResource, name), &v1alpha1.LogAnalyticsLinkedService{})
	return err
}
...
func (c *FakeLogAnalyticsLinkedServices) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(loganalyticslinkedservicesResource, listOptions)
...
func (c *FakeLogAnalyticsLinkedServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LogAnalyticsLinkedService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(loganalyticslinkedservicesResource, name, pt, data, subresources...), &v1alpha1.LogAnalyticsLinkedService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LogAnalyticsLinkedService), err
