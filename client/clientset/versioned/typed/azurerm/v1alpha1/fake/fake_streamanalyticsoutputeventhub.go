...
func (c *FakeStreamAnalyticsOutputEventhubs) Get(name string, options v1.GetOptions) (result *v1alpha1.StreamAnalyticsOutputEventhub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(streamanalyticsoutputeventhubsResource, name), &v1alpha1.StreamAnalyticsOutputEventhub{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStreamAnalyticsOutputEventhubs) List(opts v1.ListOptions) (result *v1alpha1.StreamAnalyticsOutputEventhubList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(streamanalyticsoutputeventhubsResource, streamanalyticsoutputeventhubsKind, opts), &v1alpha1.StreamAnalyticsOutputEventhubList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeStreamAnalyticsOutputEventhubs) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(streamanalyticsoutputeventhubsResource, opts))
}
...
func (c *FakeStreamAnalyticsOutputEventhubs) Create(streamAnalyticsOutputEventhub *v1alpha1.StreamAnalyticsOutputEventhub) (result *v1alpha1.StreamAnalyticsOutputEventhub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(streamanalyticsoutputeventhubsResource, streamAnalyticsOutputEventhub), &v1alpha1.StreamAnalyticsOutputEventhub{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StreamAnalyticsOutputEventhub), err
...
func (c *FakeStreamAnalyticsOutputEventhubs) Update(streamAnalyticsOutputEventhub *v1alpha1.StreamAnalyticsOutputEventhub) (result *v1alpha1.StreamAnalyticsOutputEventhub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(streamanalyticsoutputeventhubsResource, streamAnalyticsOutputEventhub), &v1alpha1.StreamAnalyticsOutputEventhub{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StreamAnalyticsOutputEventhub), err
...
func (c *FakeStreamAnalyticsOutputEventhubs) UpdateStatus(streamAnalyticsOutputEventhub *v1alpha1.StreamAnalyticsOutputEventhub) (*v1alpha1.StreamAnalyticsOutputEventhub, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(streamanalyticsoutputeventhubsResource, "status", streamAnalyticsOutputEventhub), &v1alpha1.StreamAnalyticsOutputEventhub{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StreamAnalyticsOutputEventhub), err
...
func (c *FakeStreamAnalyticsOutputEventhubs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(streamanalyticsoutputeventhubsResource, name), &v1alpha1.StreamAnalyticsOutputEventhub{})
	return err
}
...
func (c *FakeStreamAnalyticsOutputEventhubs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(streamanalyticsoutputeventhubsResource, listOptions)
...
func (c *FakeStreamAnalyticsOutputEventhubs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StreamAnalyticsOutputEventhub, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(streamanalyticsoutputeventhubsResource, name, pt, data, subresources...), &v1alpha1.StreamAnalyticsOutputEventhub{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.StreamAnalyticsOutputEventhub), err
