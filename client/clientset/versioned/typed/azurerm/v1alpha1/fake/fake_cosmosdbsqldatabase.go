...
func (c *FakeCosmosdbSqlDatabases) Get(name string, options v1.GetOptions) (result *v1alpha1.CosmosdbSqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(cosmosdbsqldatabasesResource, name), &v1alpha1.CosmosdbSqlDatabase{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCosmosdbSqlDatabases) List(opts v1.ListOptions) (result *v1alpha1.CosmosdbSqlDatabaseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(cosmosdbsqldatabasesResource, cosmosdbsqldatabasesKind, opts), &v1alpha1.CosmosdbSqlDatabaseList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeCosmosdbSqlDatabases) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(cosmosdbsqldatabasesResource, opts))
}
...
func (c *FakeCosmosdbSqlDatabases) Create(cosmosdbSqlDatabase *v1alpha1.CosmosdbSqlDatabase) (result *v1alpha1.CosmosdbSqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(cosmosdbsqldatabasesResource, cosmosdbSqlDatabase), &v1alpha1.CosmosdbSqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CosmosdbSqlDatabase), err
...
func (c *FakeCosmosdbSqlDatabases) Update(cosmosdbSqlDatabase *v1alpha1.CosmosdbSqlDatabase) (result *v1alpha1.CosmosdbSqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(cosmosdbsqldatabasesResource, cosmosdbSqlDatabase), &v1alpha1.CosmosdbSqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CosmosdbSqlDatabase), err
...
func (c *FakeCosmosdbSqlDatabases) UpdateStatus(cosmosdbSqlDatabase *v1alpha1.CosmosdbSqlDatabase) (*v1alpha1.CosmosdbSqlDatabase, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(cosmosdbsqldatabasesResource, "status", cosmosdbSqlDatabase), &v1alpha1.CosmosdbSqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CosmosdbSqlDatabase), err
...
func (c *FakeCosmosdbSqlDatabases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(cosmosdbsqldatabasesResource, name), &v1alpha1.CosmosdbSqlDatabase{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeCosmosdbSqlDatabases) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(cosmosdbsqldatabasesResource, listOptions)
...
func (c *FakeCosmosdbSqlDatabases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CosmosdbSqlDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(cosmosdbsqldatabasesResource, name, pt, data, subresources...), &v1alpha1.CosmosdbSqlDatabase{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CosmosdbSqlDatabase), err
