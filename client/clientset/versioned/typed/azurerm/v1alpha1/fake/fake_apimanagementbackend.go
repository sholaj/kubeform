...
func (c *FakeApiManagementBackends) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiManagementBackend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(apimanagementbackendsResource, name), &v1alpha1.ApiManagementBackend{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiManagementBackends) List(opts v1.ListOptions) (result *v1alpha1.ApiManagementBackendList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(apimanagementbackendsResource, apimanagementbackendsKind, opts), &v1alpha1.ApiManagementBackendList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeApiManagementBackends) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(apimanagementbackendsResource, opts))
}
...
func (c *FakeApiManagementBackends) Create(apiManagementBackend *v1alpha1.ApiManagementBackend) (result *v1alpha1.ApiManagementBackend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(apimanagementbackendsResource, apiManagementBackend), &v1alpha1.ApiManagementBackend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementBackend), err
...
func (c *FakeApiManagementBackends) Update(apiManagementBackend *v1alpha1.ApiManagementBackend) (result *v1alpha1.ApiManagementBackend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(apimanagementbackendsResource, apiManagementBackend), &v1alpha1.ApiManagementBackend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementBackend), err
...
func (c *FakeApiManagementBackends) UpdateStatus(apiManagementBackend *v1alpha1.ApiManagementBackend) (*v1alpha1.ApiManagementBackend, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(apimanagementbackendsResource, "status", apiManagementBackend), &v1alpha1.ApiManagementBackend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementBackend), err
...
func (c *FakeApiManagementBackends) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(apimanagementbackendsResource, name), &v1alpha1.ApiManagementBackend{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeApiManagementBackends) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(apimanagementbackendsResource, listOptions)
...
func (c *FakeApiManagementBackends) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiManagementBackend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apimanagementbackendsResource, name, pt, data, subresources...), &v1alpha1.ApiManagementBackend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApiManagementBackend), err
