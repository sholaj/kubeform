...
type DevTestLinuxVirtualMachinesGetter interface {
	DevTestLinuxVirtualMachines() DevTestLinuxVirtualMachineInterface
}
...
func newDevTestLinuxVirtualMachines(c *AzurermV1alpha1Client) *devTestLinuxVirtualMachines {
