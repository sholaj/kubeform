...
type StreamAnalyticsStreamInputBlobsGetter interface {
	StreamAnalyticsStreamInputBlobs() StreamAnalyticsStreamInputBlobInterface
}
...
func newStreamAnalyticsStreamInputBlobs(c *AzurermV1alpha1Client) *streamAnalyticsStreamInputBlobs {
