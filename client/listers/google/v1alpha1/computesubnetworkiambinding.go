...
type ComputeSubnetworkIamBindingLister interface {
	...
	// Get retrieves the ComputeSubnetworkIamBinding from the index for a given name.
...
// Get retrieves the ComputeSubnetworkIamBinding from the index for a given name.
func (s *computeSubnetworkIamBindingLister) Get(name string) (*v1alpha1.ComputeSubnetworkIamBinding, error) {
