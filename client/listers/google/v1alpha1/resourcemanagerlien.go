...
type ResourceManagerLienLister interface {
	...
	// Get retrieves the ResourceManagerLien from the index for a given name.
...
// Get retrieves the ResourceManagerLien from the index for a given name.
func (s *resourceManagerLienLister) Get(name string) (*v1alpha1.ResourceManagerLien, error) {
