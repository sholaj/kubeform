...
type ComputeTargetHttpProxyLister interface {
	...
	// Get retrieves the ComputeTargetHttpProxy from the index for a given name.
...
// Get retrieves the ComputeTargetHttpProxy from the index for a given name.
func (s *computeTargetHttpProxyLister) Get(name string) (*v1alpha1.ComputeTargetHttpProxy, error) {
