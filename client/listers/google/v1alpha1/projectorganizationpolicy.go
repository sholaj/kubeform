...
type ProjectOrganizationPolicyLister interface {
	...
	// Get retrieves the ProjectOrganizationPolicy from the index for a given name.
...
// Get retrieves the ProjectOrganizationPolicy from the index for a given name.
func (s *projectOrganizationPolicyLister) Get(name string) (*v1alpha1.ProjectOrganizationPolicy, error) {
