...
type RuntimeconfigConfigLister interface {
	...
	// Get retrieves the RuntimeconfigConfig from the index for a given name.
...
// Get retrieves the RuntimeconfigConfig from the index for a given name.
func (s *runtimeconfigConfigLister) Get(name string) (*v1alpha1.RuntimeconfigConfig, error) {
