...
type ComputeSharedVpcServiceProjectLister interface {
	...
	// Get retrieves the ComputeSharedVpcServiceProject from the index for a given name.
...
// Get retrieves the ComputeSharedVpcServiceProject from the index for a given name.
func (s *computeSharedVpcServiceProjectLister) Get(name string) (*v1alpha1.ComputeSharedVpcServiceProject, error) {
