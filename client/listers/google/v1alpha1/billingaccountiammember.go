...
type BillingAccountIamMemberLister interface {
	...
	// Get retrieves the BillingAccountIamMember from the index for a given name.
...
// Get retrieves the BillingAccountIamMember from the index for a given name.
func (s *billingAccountIamMemberLister) Get(name string) (*v1alpha1.BillingAccountIamMember, error) {
