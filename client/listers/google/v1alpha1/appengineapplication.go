...
type AppEngineApplicationLister interface {
	...
	// Get retrieves the AppEngineApplication from the index for a given name.
...
// Get retrieves the AppEngineApplication from the index for a given name.
func (s *appEngineApplicationLister) Get(name string) (*v1alpha1.AppEngineApplication, error) {
