...
type StorageNotificationLister interface {
	...
	// Get retrieves the StorageNotification from the index for a given name.
...
// Get retrieves the StorageNotification from the index for a given name.
func (s *storageNotificationLister) Get(name string) (*v1alpha1.StorageNotification, error) {
