...
type KmsKeyRingIamBindingLister interface {
	...
	// Get retrieves the KmsKeyRingIamBinding from the index for a given name.
...
// Get retrieves the KmsKeyRingIamBinding from the index for a given name.
func (s *kmsKeyRingIamBindingLister) Get(name string) (*v1alpha1.KmsKeyRingIamBinding, error) {
