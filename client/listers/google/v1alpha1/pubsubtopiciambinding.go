...
type PubsubTopicIamBindingLister interface {
	...
	// Get retrieves the PubsubTopicIamBinding from the index for a given name.
...
// Get retrieves the PubsubTopicIamBinding from the index for a given name.
func (s *pubsubTopicIamBindingLister) Get(name string) (*v1alpha1.PubsubTopicIamBinding, error) {
