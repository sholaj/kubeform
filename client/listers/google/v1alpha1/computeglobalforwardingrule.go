...
type ComputeGlobalForwardingRuleLister interface {
	...
	// Get retrieves the ComputeGlobalForwardingRule from the index for a given name.
...
// Get retrieves the ComputeGlobalForwardingRule from the index for a given name.
func (s *computeGlobalForwardingRuleLister) Get(name string) (*v1alpha1.ComputeGlobalForwardingRule, error) {
