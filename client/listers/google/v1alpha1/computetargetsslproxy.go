...
type ComputeTargetSslProxyLister interface {
	...
	// Get retrieves the ComputeTargetSslProxy from the index for a given name.
...
// Get retrieves the ComputeTargetSslProxy from the index for a given name.
func (s *computeTargetSslProxyLister) Get(name string) (*v1alpha1.ComputeTargetSslProxy, error) {
