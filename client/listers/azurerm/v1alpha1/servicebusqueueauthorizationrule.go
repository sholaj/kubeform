...
type ServicebusQueueAuthorizationRuleLister interface {
	...
	// Get retrieves the ServicebusQueueAuthorizationRule from the index for a given name.
...
// Get retrieves the ServicebusQueueAuthorizationRule from the index for a given name.
func (s *servicebusQueueAuthorizationRuleLister) Get(name string) (*v1alpha1.ServicebusQueueAuthorizationRule, error) {
