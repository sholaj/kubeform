...
type SecurityCenterContactLister interface {
	...
	// Get retrieves the SecurityCenterContact from the index for a given name.
...
// Get retrieves the SecurityCenterContact from the index for a given name.
func (s *securityCenterContactLister) Get(name string) (*v1alpha1.SecurityCenterContact, error) {
