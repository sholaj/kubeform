...
type SecurityCenterSubscriptionPricingLister interface {
	...
	// Get retrieves the SecurityCenterSubscriptionPricing from the index for a given name.
...
// Get retrieves the SecurityCenterSubscriptionPricing from the index for a given name.
func (s *securityCenterSubscriptionPricingLister) Get(name string) (*v1alpha1.SecurityCenterSubscriptionPricing, error) {
