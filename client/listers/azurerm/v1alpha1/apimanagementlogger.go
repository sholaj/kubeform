...
type ApiManagementLoggerLister interface {
	...
	// Get retrieves the ApiManagementLogger from the index for a given name.
...
// Get retrieves the ApiManagementLogger from the index for a given name.
func (s *apiManagementLoggerLister) Get(name string) (*v1alpha1.ApiManagementLogger, error) {
