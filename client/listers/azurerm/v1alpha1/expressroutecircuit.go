...
type ExpressRouteCircuitLister interface {
	...
	// Get retrieves the ExpressRouteCircuit from the index for a given name.
...
// Get retrieves the ExpressRouteCircuit from the index for a given name.
func (s *expressRouteCircuitLister) Get(name string) (*v1alpha1.ExpressRouteCircuit, error) {
