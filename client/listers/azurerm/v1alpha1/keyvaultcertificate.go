...
type KeyVaultCertificateLister interface {
	...
	// Get retrieves the KeyVaultCertificate from the index for a given name.
...
// Get retrieves the KeyVaultCertificate from the index for a given name.
func (s *keyVaultCertificateLister) Get(name string) (*v1alpha1.KeyVaultCertificate, error) {
