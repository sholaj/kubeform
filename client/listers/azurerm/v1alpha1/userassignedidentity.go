...
type UserAssignedIdentityLister interface {
	...
	// Get retrieves the UserAssignedIdentity from the index for a given name.
...
// Get retrieves the UserAssignedIdentity from the index for a given name.
func (s *userAssignedIdentityLister) Get(name string) (*v1alpha1.UserAssignedIdentity, error) {
