...
type HdinsightStormClusterLister interface {
	...
	// Get retrieves the HdinsightStormCluster from the index for a given name.
...
// Get retrieves the HdinsightStormCluster from the index for a given name.
func (s *hdinsightStormClusterLister) Get(name string) (*v1alpha1.HdinsightStormCluster, error) {
