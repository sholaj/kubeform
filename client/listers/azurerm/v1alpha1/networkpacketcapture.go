...
type NetworkPacketCaptureLister interface {
	...
	// Get retrieves the NetworkPacketCapture from the index for a given name.
...
// Get retrieves the NetworkPacketCapture from the index for a given name.
func (s *networkPacketCaptureLister) Get(name string) (*v1alpha1.NetworkPacketCapture, error) {
