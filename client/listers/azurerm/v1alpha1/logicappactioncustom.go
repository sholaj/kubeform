...
type LogicAppActionCustomLister interface {
	...
	// Get retrieves the LogicAppActionCustom from the index for a given name.
...
// Get retrieves the LogicAppActionCustom from the index for a given name.
func (s *logicAppActionCustomLister) Get(name string) (*v1alpha1.LogicAppActionCustom, error) {
