...
type DatabricksWorkspaceLister interface {
	...
	// Get retrieves the DatabricksWorkspace from the index for a given name.
...
// Get retrieves the DatabricksWorkspace from the index for a given name.
func (s *databricksWorkspaceLister) Get(name string) (*v1alpha1.DatabricksWorkspace, error) {
