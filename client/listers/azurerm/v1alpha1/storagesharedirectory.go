...
type StorageShareDirectoryLister interface {
	...
	// Get retrieves the StorageShareDirectory from the index for a given name.
...
// Get retrieves the StorageShareDirectory from the index for a given name.
func (s *storageShareDirectoryLister) Get(name string) (*v1alpha1.StorageShareDirectory, error) {
