...
type ApplicationInsightsLister interface {
	...
	// Get retrieves the ApplicationInsights from the index for a given name.
...
// Get retrieves the ApplicationInsights from the index for a given name.
func (s *applicationInsightsLister) Get(name string) (*v1alpha1.ApplicationInsights, error) {
