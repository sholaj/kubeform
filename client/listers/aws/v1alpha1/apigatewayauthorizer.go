...
type ApiGatewayAuthorizerLister interface {
	...
	// Get retrieves the ApiGatewayAuthorizer from the index for a given name.
...
// Get retrieves the ApiGatewayAuthorizer from the index for a given name.
func (s *apiGatewayAuthorizerLister) Get(name string) (*v1alpha1.ApiGatewayAuthorizer, error) {
