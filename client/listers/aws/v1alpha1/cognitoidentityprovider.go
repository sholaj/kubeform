...
type CognitoIdentityProviderLister interface {
	...
	// Get retrieves the CognitoIdentityProvider from the index for a given name.
...
// Get retrieves the CognitoIdentityProvider from the index for a given name.
func (s *cognitoIdentityProviderLister) Get(name string) (*v1alpha1.CognitoIdentityProvider, error) {
