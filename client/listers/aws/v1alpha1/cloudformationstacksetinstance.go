...
type CloudformationStackSetInstanceLister interface {
	...
	// Get retrieves the CloudformationStackSetInstance from the index for a given name.
...
// Get retrieves the CloudformationStackSetInstance from the index for a given name.
func (s *cloudformationStackSetInstanceLister) Get(name string) (*v1alpha1.CloudformationStackSetInstance, error) {
