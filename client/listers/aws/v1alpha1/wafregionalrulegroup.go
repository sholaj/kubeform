...
type WafregionalRuleGroupLister interface {
	...
	// Get retrieves the WafregionalRuleGroup from the index for a given name.
...
// Get retrieves the WafregionalRuleGroup from the index for a given name.
func (s *wafregionalRuleGroupLister) Get(name string) (*v1alpha1.WafregionalRuleGroup, error) {
