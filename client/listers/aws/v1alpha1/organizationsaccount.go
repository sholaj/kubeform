...
type OrganizationsAccountLister interface {
	...
	// Get retrieves the OrganizationsAccount from the index for a given name.
...
// Get retrieves the OrganizationsAccount from the index for a given name.
func (s *organizationsAccountLister) Get(name string) (*v1alpha1.OrganizationsAccount, error) {
