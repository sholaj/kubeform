...
type PinpointApnsChannelLister interface {
	...
	// Get retrieves the PinpointApnsChannel from the index for a given name.
...
// Get retrieves the PinpointApnsChannel from the index for a given name.
func (s *pinpointApnsChannelLister) Get(name string) (*v1alpha1.PinpointApnsChannel, error) {
