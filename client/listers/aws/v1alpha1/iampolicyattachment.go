...
type IamPolicyAttachmentLister interface {
	...
	// Get retrieves the IamPolicyAttachment from the index for a given name.
...
// Get retrieves the IamPolicyAttachment from the index for a given name.
func (s *iamPolicyAttachmentLister) Get(name string) (*v1alpha1.IamPolicyAttachment, error) {
