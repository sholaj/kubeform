...
type AlbListenerCertificateLister interface {
	...
	// Get retrieves the AlbListenerCertificate from the index for a given name.
...
// Get retrieves the AlbListenerCertificate from the index for a given name.
func (s *albListenerCertificateLister) Get(name string) (*v1alpha1.AlbListenerCertificate, error) {
