...
type GlueSecurityConfigurationLister interface {
	...
	// Get retrieves the GlueSecurityConfiguration from the index for a given name.
...
// Get retrieves the GlueSecurityConfiguration from the index for a given name.
func (s *glueSecurityConfigurationLister) Get(name string) (*v1alpha1.GlueSecurityConfiguration, error) {
