...
type IotPolicyAttachmentLister interface {
	...
	// Get retrieves the IotPolicyAttachment from the index for a given name.
...
// Get retrieves the IotPolicyAttachment from the index for a given name.
func (s *iotPolicyAttachmentLister) Get(name string) (*v1alpha1.IotPolicyAttachment, error) {
