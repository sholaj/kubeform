...
type RedshiftSubnetGroupLister interface {
	...
	// Get retrieves the RedshiftSubnetGroup from the index for a given name.
...
// Get retrieves the RedshiftSubnetGroup from the index for a given name.
func (s *redshiftSubnetGroupLister) Get(name string) (*v1alpha1.RedshiftSubnetGroup, error) {
