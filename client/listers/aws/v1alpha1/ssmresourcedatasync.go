...
type SsmResourceDataSyncLister interface {
	...
	// Get retrieves the SsmResourceDataSync from the index for a given name.
...
// Get retrieves the SsmResourceDataSync from the index for a given name.
func (s *ssmResourceDataSyncLister) Get(name string) (*v1alpha1.SsmResourceDataSync, error) {
