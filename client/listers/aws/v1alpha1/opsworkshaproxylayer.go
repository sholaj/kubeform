...
type OpsworksHaproxyLayerLister interface {
	...
	// Get retrieves the OpsworksHaproxyLayer from the index for a given name.
...
// Get retrieves the OpsworksHaproxyLayer from the index for a given name.
func (s *opsworksHaproxyLayerLister) Get(name string) (*v1alpha1.OpsworksHaproxyLayer, error) {
