...
type DxGatewayAssociationLister interface {
	...
	// Get retrieves the DxGatewayAssociation from the index for a given name.
...
// Get retrieves the DxGatewayAssociation from the index for a given name.
func (s *dxGatewayAssociationLister) Get(name string) (*v1alpha1.DxGatewayAssociation, error) {
