...
type DxConnectionAssociationLister interface {
	...
	// Get retrieves the DxConnectionAssociation from the index for a given name.
...
// Get retrieves the DxConnectionAssociation from the index for a given name.
func (s *dxConnectionAssociationLister) Get(name string) (*v1alpha1.DxConnectionAssociation, error) {
