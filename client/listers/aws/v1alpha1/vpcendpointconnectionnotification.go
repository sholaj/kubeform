...
type VpcEndpointConnectionNotificationLister interface {
	...
	// Get retrieves the VpcEndpointConnectionNotification from the index for a given name.
...
// Get retrieves the VpcEndpointConnectionNotification from the index for a given name.
func (s *vpcEndpointConnectionNotificationLister) Get(name string) (*v1alpha1.VpcEndpointConnectionNotification, error) {
