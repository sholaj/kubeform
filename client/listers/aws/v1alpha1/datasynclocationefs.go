...
type DatasyncLocationEfsLister interface {
	...
	// Get retrieves the DatasyncLocationEfs from the index for a given name.
...
// Get retrieves the DatasyncLocationEfs from the index for a given name.
func (s *datasyncLocationEfsLister) Get(name string) (*v1alpha1.DatasyncLocationEfs, error) {
