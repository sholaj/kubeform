...
type CognitoIdentityPoolLister interface {
	...
	// Get retrieves the CognitoIdentityPool from the index for a given name.
...
// Get retrieves the CognitoIdentityPool from the index for a given name.
func (s *cognitoIdentityPoolLister) Get(name string) (*v1alpha1.CognitoIdentityPool, error) {
