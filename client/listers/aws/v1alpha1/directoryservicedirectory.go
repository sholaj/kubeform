...
type DirectoryServiceDirectoryLister interface {
	...
	// Get retrieves the DirectoryServiceDirectory from the index for a given name.
...
// Get retrieves the DirectoryServiceDirectory from the index for a given name.
func (s *directoryServiceDirectoryLister) Get(name string) (*v1alpha1.DirectoryServiceDirectory, error) {
