...
type NeptuneClusterInstanceLister interface {
	...
	// Get retrieves the NeptuneClusterInstance from the index for a given name.
...
// Get retrieves the NeptuneClusterInstance from the index for a given name.
func (s *neptuneClusterInstanceLister) Get(name string) (*v1alpha1.NeptuneClusterInstance, error) {
