...
type LambdaEventSourceMappingLister interface {
	...
	// Get retrieves the LambdaEventSourceMapping from the index for a given name.
...
// Get retrieves the LambdaEventSourceMapping from the index for a given name.
func (s *lambdaEventSourceMappingLister) Get(name string) (*v1alpha1.LambdaEventSourceMapping, error) {
