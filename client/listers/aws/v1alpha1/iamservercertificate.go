...
type IamServerCertificateLister interface {
	...
	// Get retrieves the IamServerCertificate from the index for a given name.
...
// Get retrieves the IamServerCertificate from the index for a given name.
func (s *iamServerCertificateLister) Get(name string) (*v1alpha1.IamServerCertificate, error) {
