...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/kubeform/apis/register.go/v1alpha1.State":          schema_kubeform_apis_registergo_v1alpha1_State(ref),
	}
}
...
func schema_kubeform_apis_registergo_v1alpha1_State(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
