...
func (in *ComputeSnapshotSpec) DeepCopyInto(out *ComputeSnapshotSpec) {
	*out = *in
	...
	if in.SnapshotEncryptionKeyRaw != nil {
		in, out := &in.SnapshotEncryptionKeyRaw, &out.SnapshotEncryptionKeyRaw
		*out = new(v1.LocalObjectReference)
		**out = **in
	}
	...
	if in.SourceDiskEncryptionKeyRaw != nil {
		in, out := &in.SourceDiskEncryptionKeyRaw, &out.SourceDiskEncryptionKeyRaw
		*out = new(v1.LocalObjectReference)
		**out = **in
	}
	out.ProviderRef = in.ProviderRef
