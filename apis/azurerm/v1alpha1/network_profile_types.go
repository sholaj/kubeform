...
type NetworkProfileSpecContainerNetworkInterface struct {
	IpConfiguration []NetworkProfileSpecContainerNetworkInterface `json:"ip_configuration"`
	Name            string                                        `json:"name"`
}

type NetworkProfileSpec struct {
	// +kubebuilder:validation:MaxItems=1
	ContainerNetworkInterface []NetworkProfileSpec `json:"container_network_interface"`
