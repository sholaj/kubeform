...
type OpsworksRailsAppLayerSpec struct {
	...
	// +optional
	// +kubebuilder:validation:UniqueItems=true
	EbsVolume *[]OpsworksRailsAppLayerSpec `json:"ebs_volume,omitempty"`
	// +optional
	...
	// +optional
	ManageBundler bool `json:"manage_bundler,omitempty"`
	// +optional
	Name string `json:"name,omitempty"`
	// +optional
	PassengerVersion string `json:"passenger_version,omitempty"`
	// +optional
