...
type DatabaseFirewall struct {
	...
	Spec              DatabaseFirewallSpec   `json:"spec,omitempty"`
	Status            DatabaseFirewallStatus `json:"status,omitempty"`
}

type DatabaseFirewallSpecRule struct {
	// +optional
...
type DatabaseFirewallStatus struct {
	...
	// +optional
	Output *DatabaseFirewallSpec `json:"output,omitempty"`
	// +optional
...
type DatabaseFirewallList struct {
	...
	// Items is a list of DatabaseFirewall CRD objects
	Items []DatabaseFirewall `json:"items,omitempty"`
}
